                        ...
                        <tr>
                            ...
                            <td>
                                <img class="blur-up lazyloaded"
                                    data-src="{{ asset('storage/system_images/wishlist_display_style.jpeg') }}"
                                    src="{{ asset('storage/system_images/wishlist_display_style.jpeg') }}"
                           ...
                           <td>
                                <div class="btn btn-md text-nowrap">Add to Cart</div>
                            </td>
                        </tr>
                    </tbody>
                </table>
