...
@section('title')
    {{ labels('admin_labels.manage_product_pickup_locations', 'Manage Product Pickup Locations') }}
@endsection
@section('content')
    <x-seller.breadcrumb :title="labels('admin_labels.manage_product_pickup_locations', 'Manage Product Pickup Locations')" :subtitle="labels(
        'admin_labels.bulk_update_pickup_locations_for_products',
        'Bulk Update Pickup Locations for Your Products',
    )" :breadcrumbs="[['label' => labels('admin_labels.manage_product_pickup_locations', 'Manage Product Pickup Locations')]]" />
    <div class="col-md-12">
        <div class="row">
                    ...
                    <div class="card content-area p-4 ">
                        <div class="row align-items-center d-flex heading mb-5">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h4>{{ labels('admin_labels.manage_product_pickup_locations', 'Manage Product Pickup Locations') }}
                                        </h4>
                                    </div>
                                    ...
                                    <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                        <div class="input-group me-2 search-input-grp ">
                                            ...
                                            <input type="text" data-table="seller_pickup_location_products_table"
                                        ...
                                        <a class="btn me-2" id="tableFilter" data-bs-toggle="offcanvas"
                                            data-bs-target="#columnFilterOffcanvas" data-table="seller_pickup_location_products_table"
                                            StatusFilter='true'><i class='bx bx-filter-alt'></i></a>
                                        <a class="btn me-2" id="tableRefresh" data-table="seller_pickup_location_products_table"><i
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('seller_pickup_location_products_table','csv')">CSV</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('seller_pickup_location_products_table','json')">JSON</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('seller_pickup_location_products_table','sql')">SQL</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('seller_pickup_location_products_table','excel')">Excel</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <button type="button"
                                    ...
                                    data-table-id="seller_pickup_location_products_table"
                                    data-url="{{ route('seller.pickup_locations.bulk.update') }}">{{ labels('admin_labels.bulk_update', 'Bulk Update') }}</button>
                            </div>
                            <div class="col-md-12">
                                <div class="pt-0">
                                    <div class="table-responsive">
                                        <table class='table' id="seller_pickup_location_products_table" data-toggle="table"
                                            data-loading-template="loadingTemplate"
                                            data-url="{{ route('seller.product.pickup_locations.list') }}"
