...
@section('content')
    <section class="main-content">
        ...
        <div class="row">
            <x-seller.breadcrumb :title="labels('admin_labels.area', 'Area')" :subtitle="'All information about area'" :breadcrumbs="[
                ['label' => labels('admin_labels.location_management', 'Location Management')],
                ['label' => labels('admin_labels.location', 'Locations')],
                ['label' => labels('admin_labels.area', 'Area')],
            ]" />
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('seller_area_table','csv')">CSV</button></li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('seller_area_table','json')">JSON</button></li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('seller_area_table','sql')">SQL</button></li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('seller_area_table','excel')">Excel</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="pt-0">
                                <div class="table-responsive">
                                    <table class='table' id="seller_area_table" data-toggle="table"
                                        data-loading-template="loadingTemplate" data-url="{{ route('seller.area.list') }}"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="city_name" data-sortable="false">
                                                    {{ labels('admin_labels.city', 'City') }}</th>
                                                <th data-field="zipcode" data-sortable="false">
                                                    {{ labels('admin_labels.zipcodes', 'Zipcodes') }}</th>
