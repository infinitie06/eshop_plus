...
@section('content')
    <section class="main-content">
        ...
        <x-seller.breadcrumb :title="labels('admin_labels.stock_manage', 'Stock Manage')" :subtitle="labels('admin_labels.know_your_stock_grow_your_business', 'Know your stock, grow your business')" :breadcrumbs="[['label' => labels('admin_labels.stock_manage', 'Combo Stock Manage')]]" />
        {{-- modal --}}
                    ...
                    <form enctype="multipart/form-data" method="POST" class="submit_form">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel">
                                {{ labels('admin_labels.update_stock', 'Update Stock') }}</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-6 d-flex justify-content-end">
                                ...
                                <a class="btn me-2" id="tableFilter" data-bs-toggle="offcanvas"
                                    data-bs-target="#columnFilterOffcanvas" data-table="seller_product_stock_table"
                                ...
                                <div class="pt-0">
                                    <div class="table-responsive">
                                        <table id='seller_product_stock_table' data-toggle="table"
                                            ...
                                            data-url="{{ route('seller.manage_combo_stock.list') }}"
                                            ...
                                            <thead>
                                                <tr>
                                                    <th data-field="id" data-sortable="true">
                                                        {{ labels('admin_labels.product_id', 'Product ID') }}</th>
                                                    <th data-field="name" data-disabled="1" data-sortable="false">
                                                        {{ labels('admin_labels.product', 'Product') }}</th>
                                                    <th data-field="price" data-sortable="false">
                                                        {{ labels('admin_labels.price', 'Price') }}</th>
                                                    <th data-field="stock_count" data-sortable="false">
                                                        {{ labels('admin_labels.stock_count', 'Stock Count') }}</th>
                                                    <th data-field="stock_status" data-sortable="false">
                                                        {{ labels('admin_labels.status', 'Stock Status') }}</th>
