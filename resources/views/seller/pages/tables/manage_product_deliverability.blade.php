...
@endsection
@section('content')
    <x-seller.breadcrumb :title="labels('admin_labels.manage_product_deliverability', 'Deliverability Manage')"
        :subtitle="labels(
            ...
            <div class="col-md-12 col-xl-12 mt-xl-0 mt-md-2">
                <section class="overview-data">
                    <div class="card content-area p-4 ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                        ...
                                        <a class="btn me-2" id="tableFilter" data-bs-toggle="offcanvas"
                                            data-bs-target="#columnFilterOffcanvas" data-table="seller_deliverability_table"
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('seller_deliverability_table','csv')">CSV</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('seller_deliverability_table','json')">JSON</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('seller_deliverability_table','sql')">SQL</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('seller_deliverability_table','excel')">Excel</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <button type="button" class="btn btn-outline-primary btn-sm bulk_update_deliverability_data"
                                    data-table-id="seller_deliverability_table"
                                    data-url="{{ route('seller.deliverability.bulk.update') }}">{{ labels('admin_labels.bulk_update', 'Bulk Update') }}</button>
                            </div>
                            <div class="col-md-12">
                                <div class="pt-0">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="deliverable_type" id="deliverable_type">
                                ...
                                <option value="2">{{ labels('admin_labels.specific_option', 'Specific') }}</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select search_seller_zone" name="deliverable_zones[]" id="deliverable_zones"
                                multiple>
                            </select>
                        </div>
