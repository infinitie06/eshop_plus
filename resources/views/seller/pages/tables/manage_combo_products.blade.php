...
@section('content')
    <section class="main-content">
        <div class="row">
            <x-seller.breadcrumb :title="labels('admin_labels.manage_products', 'Manage Products')" :subtitle="labels('admin_labels.track_and_manage_combo_products', 'Track And Manage Combo Products')" :breadcrumbs="[
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12 col-xl-4">
                                    <h4>{{ labels('admin_labels.combo_products', 'Combo Products') }}</h4>
                                </div>
                                <div class="col-md-12 col-xl-8 d-flex justify-content-end">
                                    <a href="{{ route('seller.combo_products.index') }}" class="btn btn-dark me-3"><i
                                            class='bx bx-plus-circle me-1'></i>{{ labels('admin_labels.add_product', 'Add Product') }}</a>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('seller_combo_product_table','csv')">CSV</button>
                                            </li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('seller_combo_product_table','json')">JSON</button>
                                            </li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('seller_combo_product_table','sql')">SQL</button>
                                            </li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('seller_combo_product_table','excel')">Excel</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="pt-0">
                                <div class="table-responsive">
                                    <table class='table-striped' id='seller_combo_product_table' data-toggle="table"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="products" data-sortable="false">
                                                    {{ labels('admin_labels.products', 'Products') }}</th>
