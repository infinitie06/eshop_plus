...
@section('content')
    <section class="main-content">
        <div class="row">
            <x-seller.breadcrumb :title="labels('admin_labels.withdrawal_requests', 'Withdrawal Request')"
                :subtitle="labels(
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-12">
                                    <textarea type="text" class="form-control"
                                        placeholder="{{ labels('admin_labels.payment_address', 'Payment Details') }}"
                                        name="payment_address"></textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="amount"
                                ...
                                <div class="col-sm-12">
                                    <input type="number" class="form-control"
                                        placeholder="{{ labels('admin_labels.amount', 'Amount') }}" name="amount" min=1>
                                </div>
                            </div>
                        </div>
                    </div>
