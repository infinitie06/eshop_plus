...
@section('title')
    {{ labels('admin_labels.attributes', 'Combo Attributes') }}
@endsection
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-6 d-flex justify-content-end">
                                    ...
                                    <div class="input-group me-3 search-input-grp ">
                                        ...
                                        <input type="text" data-table="seller_combo_product_attributes"
                                            class="form-control searchInput" placeholder="{{ labels('admin_labels.search', 'Search') }}">
                                        <span class="input-group-text">{{ labels('admin_labels.search', 'Search') }}</span>
                                    </div>
                                    <a class="btn me-2" id="tableFilter" data-bs-toggle="offcanvas"
                                        data-bs-target="#columnFilterOffcanvas" data-table="seller_combo_product_attributes"
                                        dateFilter='false' orderStatusFilter='false' paymentMethodFilter='false'
                                        orderTypeFilter='false'><i class='bx bx-filter-alt'></i></a>
                                    <a class="btn me-2" id="tableRefresh" data-table="seller_combo_product_attributes"><i
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('seller_combo_product_attributes','csv')">CSV</button>
                                            </li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('seller_combo_product_attributes','json')">JSON</button>
                                            </li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('seller_combo_product_attributes','sql')">SQL</button>
                                            </li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('seller_combo_product_attributes','excel')">Excel</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="pt-0">
                                <div class="table-responsive">
                                    <table id='seller_combo_product_attributes' data-toggle="table"
                                        data-loading-template="loadingTemplate"
                                        data-url="{{ route('seller.combo_product_attributes.list') }}"
                                        data-click-to-select="true" data-side-pagination="server" data-pagination="true"
                                        data-page-list="[2,5, 10, 20, 50, 100, 200]" data-search="false"
