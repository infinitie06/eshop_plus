                    ...
                    <div class="modal fade" id="add_product_faq" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <form class="form-horizontal submit_form" action="{{ route('seller.product_faqs.store') }}"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="question"
                                                    placeholder="{{ labels('admin_labels.question', 'Question') }}"
                                                    name="question">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea class="form-control" id="answer"
                                                    placeholder="{{ labels('admin_labels.answer', 'Answer') }}"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control question" id="question"
                                        placeholder="{{ labels('admin_labels.question', 'Question') }}" name="question"
                                        readonly>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="answer"
                                    class="col-sm-12 form-label">{{ labels('admin_labels.answer', 'Answer') }}<span
                                        class='text-asterisks text-sm'>*</span></label>
                                <div class="col-md-12">
                                    <textarea class="form-control answer" id="answer"
                                        placeholder="{{ labels('admin_labels.answer', 'Answer') }}"
                                        name="answer"></textarea>
                                </div>
                            </div>
