                                            ...
                                            <table id="seller_order_item_table" data-toggle="table"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-field="shipping_option_name" data-sortable='false' data-visible='true'>
                                                            {{ labels('admin_labels.shipping_option', 'Shipping Option') }}
                                                        </th>
                                                        <th data-field="shipping_carrier" data-sortable='false' data-visible='true'>
                                                            {{ labels('admin_labels.carrier', 'Carrier') }}
                                                        </th>
                                                        <th data-field="shipping_estimated_days" data-sortable='false' data-visible='true'>
                                                            {{ labels('admin_labels.estimated_delivery', 'Est. Delivery') }}
                                                        </th>
                            ...
                            <div class="row">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" name="courier_agency" id="courier_agency"
                                        placeholder="{{ labels('admin_labels.courier_agency', 'Courier Agency') }}" />
                                </div>
                                <div class="form-group ">
                                    <label
                                    ...
                                    <input type="text" class="form-control" name="tracking_id" id="tracking_id"
                                        placeholder="{{ labels('admin_labels.tracking_id', 'Tracking Id') }}" />
                                </div>
                                <div class="form-group ">
