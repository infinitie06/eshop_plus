            ...
            <form action="{{ route('seller.products.update', $data->id) }}" enctype="multipart/form-data" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="product_type_menu" class="form-label">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                        ...
                                        data-bs-content="Select whether the product is physical or digital."></i>
                                </label>
                            ...
                            <div class="col-md-6">
                                <label for="category_select" class="form-label">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                        data-bs-placement="right"
                                        data-bs-content="Select the category for this product."></i>
                                </label>
                ...
                <div class="card p-5 mt-4">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    <label for="brand_name" class="form-label">
                                        ...
                                        <span class="text-asterisks text-sm">*</span>
                                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right" data-bs-content="Enter the product name."></i>
                                    </label>
                                ...
                                <div class="mb-3 col-md-6">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <label for="short_description" class="form-label mb-0">
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Enter a short description for the product."></i>
                                        </label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="tags" class="form-label">{{ labels('admin_labels.tags', 'Tags') }} <i
                                        class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                        data-bs-placement="right"
                                        data-bs-content="Enter tags for the product, separated by commas."></i></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="pro_input_tax"
                                        class="form-label">{{ labels('admin_labels.select_tax', 'Select Tax') }} <i
                                            class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right"
                                            data-bs-content="Select applicable taxes for this product."></i></label>
                                ...
                                <div class="col-md-6 total_allowed_quantity">
                                    <div class="form-group">
                                        <label for="total_allowed_quantity"
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Maximum quantity allowed for purchase."></i></label>
                                ...
                                <div class="col-md-6 minimum_order_quantity">
                                    <div class="form-group">
                                        <label for="minimum_order_quantity"
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Minimum quantity required for purchase."></i></label>
                                        <input type="number" class="col-md-12 form-control"
                                ...
                                <div class="col-md-6 quantity_step_size">
                                    <div class="form-group">
                                        <label for="quantity_step_size"
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Step size for quantity increments."></i></label>
                                ...
                                <div class="col-md-6 d-none warranty_period">
                                    <div class="form-group">
                                        <label for="warranty_period"
                                            class="form-label">{{ labels('admin_labels.warrenty_period', 'Warrenty Period') }}<i
                                                class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Enter the warranty period if any."></i></label>
                                ...
                                <div class="col-md-6 d-none guarantee_period">
                                    <div class="form-group">
                                        <label for="guarantee_period"
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Enter the guarantee period if any."></i></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="zipcode"
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Select the deliverable type for this product."></i></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="zipcodes"
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Select the zones where this product can be delivered."></i>
                                        </label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="shipping_type"
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Select the pickup location for standard shipping."></i>
                                        </label>
                                ...
                                @if (!$shiprocketEnabled)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="zipcodes"
                                                class="form-label">{{ labels('admin_labels.minimum_free_delivery_order_quantity', 'Minimum Free Delivery Order Quantity') }}<i
                                                    class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="Minimum order quantity for free delivery."></i></label>
                            ...
                            @if (!$shiprocketEnabled)
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="zipcodes"
                                                class="form-label">{{ labels('admin_labels.delivery_charges', 'Delivery Charges') }}<i
                                                    class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="Set the delivery charges for this product."></i></label>
                                            <input type="number" class="form-control" min=0
                                ...
                                <div class="col-md-6 mt-7 {{ isset($data->is_cancelable) && $data->is_cancelable == '1' ? '' : 'collapse' }} "
                                    ...
                                    <div class="form-group">
                                        <label for="cancelable_till"
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Select the status till which the product can be canceled."></i></label>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div id="affiliate_info" style="display:none;">
                                                ...
                                                <i class="fas fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    ...
                                                    data-bs-content="If your selected category has been marked by the admin as available for affiliate, only then you can mark the product as an affiliate product. Otherwise, this option will be disabled.">
                                                </i>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="simple_price"
                                                                            ...
                                                                            <i class="fa fa-info-circle text-secondary ms-1"
                                                                                ...
                                                                                data-bs-placement="right"
                                                                                data-bs-content="Enter the product price."></i>
                                                                        </label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="type"
                                                                            ...
                                                                            <i class="fa fa-info-circle text-secondary ms-1"
                                                                                data-bs-toggle="popover"
                                                                                data-bs-placement="right"
                                                                                data-bs-content="Enter a discounted price if any."></i>
                                                                        </label>
                                                        ...
                                                        <div class="row d-flex">
                                                            <div class="col col-xs-4 col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <i class="fa fa-info-circle text-secondary ms-1"
                                                                        ...
                                                                        data-bs-content="Enter the product SKU (Stock Keeping Unit)."></i>
                                                                </div>
                                                            </div>
                                                            <div class="col col-xs-4 col-md-4">
                                                                <div class="form-group">
                                                                    <label for=""
                                                                        ...
                                                                        : <i class="fa fa-info-circle text-secondary ms-1"
                                                                            data-bs-toggle="popover"
                                                                            data-bs-placement="right"
                                                                            data-bs-content="Enter the total stock quantity."></i></label>
                                                                    <input type="number" min="0"
                                                            ...
                                                            <div class="col col-xs-4 col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <i class="fa fa-info-circle text-secondary ms-1"
                                                                        data-bs-toggle="popover" data-bs-placement="right"
                                                                        data-bs-content="Select the stock status (In Stock/Out Of Stock)."></i>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-6 {{ isset($data->download_type) && $data->download_type == 'add_link' ? '' : 'd-none' }}"
                                                        ...
                                                        <label for="video"
                                                            ...
                                                            <i class="fa fa-info-circle text-secondary ms-1"
                                                                data-bs-toggle="popover" data-bs-placement="right"
                                                                data-bs-content="Paste the video link for this product."></i>
                                                        </label>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Upload the main image for this product."></i>
                                        </label>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Upload additional images for this product."></i>
                                        </label>
                                        <div class="form-group">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="video_type" class="form-label">
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Select the type of video for this product."></i>
                                        </label>
                                    ...
                                    <div class="col-md-6 {{ isset($data->video_type) && $data->video_type == 'self_hosted' ? '' : 'd-none' }}"
                                        ...
                                        <label for="" class="form-label">
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Upload a video file for this product."></i>
                                        </label>
                                        <div class="form-group">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control mt-2 d-none mb-2 custom_extra_description_prompt"
                                    name="custom_extra_description_prompt" placeholder="Enter your own AI prompt (optional)..."></textarea>
