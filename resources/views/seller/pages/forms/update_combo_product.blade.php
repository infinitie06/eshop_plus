                    ...
                    <div class="tab-content p-3 col-md-12" id="nav-tabContent">
                        <div class="tab-pane fade active show" id="general-settings" role="tabpanel"
                            ...
                            <div id="product-general-settings">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="simple_special_price"
                                                        class="form-control discounted_price"  value="{{ $data->special_price }}">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div
                                    class="simple-product-level-stock-management {{ $data->product_type == 'digital_product' ? 'd-none' : '' }} {{ (isset($data->stock) && $data->stock != null) ? '' : 'collapse' }}">
