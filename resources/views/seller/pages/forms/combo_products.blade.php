...
@endsection
@section('content')
    <x-seller.breadcrumb :title="labels('admin_labels.add_product', 'Add Product')"
    ...
    <section class="overview-statistic">
        <div class="">
            <form action="{{ route('seller.combo_products.store') }}" class="submit_form" enctype="multipart/form-data"
                method="POST" id="">
                @csrf
                @php
                    ...
                    // dd($deliverable_type->deliverable_type);
                @endphp
                <input type="hidden" name="seller_id" value="{{ $seller_id }}">
                <div class="card p-5">
                    <h6>{{ labels('admin_labels.choose_seller', 'Select Product') }}
                    </h6>
                    <div class="row mt-4">
                        <div class="col-md-6">
                                ...
                                <div class="tab-pane fade" id="content-{{ $lang->code }}" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div id="suggestions_{{ $lang->code }}"
                                                class="list-group position-absolute dynamic_prompt_suggestions z-3 d-none">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <textarea id="language_custom_prompt_{{ $lang->code }}"
                                                ...
                                                data-lang="{{ $lang->code }}" name="custom_translated_prompt"
                                                placeholder="Enter your own AI prompt (optional)..."></textarea>
                                            <div class="position-relative w-100">
                                                <div
                    ...
                    <div class="row mt-3 d-none" id="similar_product">
                        <div class="col-md-12">
                            ...
                            <select name="similar_product_id[]"
                                class="select2 form-select search_seller_combo_product w-100" multiple></select>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div
                            ...
                            <div class="form-group city_list_parent">
                                <label for="cities"
                                    class="form-label">{{ labels('admin_labels.deliverable_cities', 'Deliverable Cities') }}</label>
                                <select name="deliverable_cities[]" class="city_list form-select w-100" multiple
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            ...
                            {{-- <textarea class="form-control mt-2 d-none mb-2 custom_description_prompt"
                                ...
                                placeholder="Enter your own AI prompt (optional)..."></textarea>
                            <textarea id="pro_input_description" name="description"
