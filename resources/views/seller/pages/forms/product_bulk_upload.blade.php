...
@section('content')
    <section class="main-content">
        <div class="container-fluid mt-5 mb-5 px-6">
            <x-seller.breadcrumb :title="labels('admin_labels.bulk_upload', 'Bulk Upload')" :subtitle="labels(
                'admin_labels.simplify_tasks_with_powerful_bulk_upload_capabilities',
                'Simplify Tasks with Powerful Bulk Upload Capabilities.',
            )" :breadcrumbs="[
                ['label' => labels('admin_labels.product', 'Product')],
            ...
            <div class="row">
                <div class="col-md-12 col-lg-6">
                    <div class="card">
                        <form class="form-horizontal" action="{{ route('seller.product.bulk_upload') }}" method="POST"
                            id="bulk_upload_form">
                            @csrf
                            <div class="card-body">
                                <h5 class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group mt-2">
                                                <a href="{{ asset('storage/product-bulk-upload.zip') }}"
                                                    class="btn btn-primary btn-sm instructions_files"
                                                    download="product-bulk-upload.zip">{{ labels('admin_labels.download', 'Download') }}
