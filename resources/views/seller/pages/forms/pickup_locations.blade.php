                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label mb-2 mt-2">
                                        {{ labels('admin_labels.select_location_on_map', 'Select Location on Map') }}
                                    </label>
                                    <div id="pickup_map"
                                        style="height: 400px; width: 100%; border-radius: 8px; border: 1px solid #ddd;">
                                    </div>
                                    <small class="text-muted">Click on the map or drag the marker to set the pickup
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="latitude"
                                        placeholder="Click on map to set latitude" id="latitude" value=""
                                        readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="longitude"
                                        placeholder="Click on map to set longitude" id="longitude" value=""
                                        readonly>
                                </div>
                            </div>
                        </div>
...
@section('script')
    ...
    <!-- Pickup Locations JS -->
    <script src="{{ asset('assets/admin/custom/pickup_locations.js') }}?v={{ time() }}"></script>
@endsection
