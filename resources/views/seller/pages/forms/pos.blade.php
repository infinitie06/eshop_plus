...
@section('content')
                                ...
                                <nav class="w-100">
                                    <div class="nav nav-tabs" id="media-tab" role="tablist">
                                        <a class="nav-item nav-link pos-nav-tab-link active" data-tab="product_tab"
                                            data-bs-toggle="tab" href="#nav-product" role="tab" aria-controls="nav-product"
                                ...
                                <div class="align-items-center d-flex form-group justify-content-end row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <select class="form-select" id="product_categories" name="category_parent">
                                            <option value="">
                                                <?= isset($categories) && empty($categories) ? labels('admin_labels.no_categories_exist', 'No Categories Exist') : labels('admin_labels.select_categories', 'Select Categories') ?>
                                            </option>
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group me-3 search-input-grp product-search">
                                            ...
                                            <input type="text" name="search_products" class="form-control"
                                                id="search_products" value=""
                                                placeholder="{{ labels('admin_labels.search_products', 'Search Products') }}">
                                        </div>
                                        <div class="input-group me-3 search-input-grp combo-product-search d-none">
                                            <span class="search-icon"><i class='bx bx-search-alt'></i></span>
                                            <input type="text" name="search_products" class="form-control"
                                                id="search_combo_products" value="" placeholder="{{ labels('panel_labels.search_combo_products', 'Search combo Products') }}">
                                        </div>
                                    </div>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-combo-poduct" role="tabpanel">
                                ...
                                <div class="mt-4">
                                    ...
                                    <input type="hidden" name="current_page" id="combo_product_current_page" value="0" />
                        ...
                        <form id="pos_form" method="POST" action='{{ route('place.order') }}'>
                            ...
                            <div class="card p-5">
                                <div class="align-items-center d-flex justify-content-between">
                                    ...
                                    <div class=""><button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#register"><i class='bx bx-user-plus me-1'></i>
                                ...
                                <input type="hidden" name="product_address" id="product_customer_address" value="">
                            ...
                            <div class="card p-5 mt-5">
                                <div class="col-md-12 pos-cart-header d-flex justify-content-between align-items-center">
                                    ...
                                    <button class="btn btn-sm btn-purchase btn-primary mb-2 d-none place_order_btn"
                                        type="submit" id="">{{ labels('admin_labels.place_order', 'Place Order') }}</button>
                                </div>
                                ...
                                <div class="col-md-12 mt-5">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="delivery_charge_service form-control"
                                            id="delivery_charge_service" value="" placeholder="0.00" name="delivery_charge">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="discount_service form-control" id="discount_service"
                                            value="" placeholder="0.00" name="discount">
                                    </div>
                    ...
                    <section>
                        <form id="combo_product_form" method="POST" action="{{ route('combo.place.order') }}">
                            ...
                            <div class="card p-5">
                                ...
                                <input type="hidden" name="combo_hidden_sub_total" class="combo_hidden_sub_total" value="">
                                <input type="hidden" name="payment_method" id="combo_payment_method" value="">
                                <input type="hidden" name="payment_method_name" id="combo_payment_method_name" value="">
                            ...
                            <div class="card p-5 mt-5">
                                <div class="col-md-12  d-flex justify-content-between align-items-center">
                                    <h6>{{ labels('admin_labels.shipping_address', 'Shipping Address') }}</h6>
                                    <a href="#" class="btn active combo_customer_edit_address d-none" type="button"
                                        data-bs-toggle="modal"
                                ...
                                <div class="col-md-12 mt-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="combo_discount_service form-control"
                                            id="combo_discount_service" value="" placeholder="0.00" name="discount"
                                            min="0.00">
                                    </div>
                                    <div class="col-lg-12 billing-detail-table">
                                        <table class="table table-borderless w-100">
                                    ...
                                    <button type="button" class="btn btn-primary mt-5 float-end cart_combo_product_payment"
                                        data-bs-toggle="modal"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary add_combo_button" id="" name="" data-dismiss="modal"
                            value="Save">{{ labels('admin_labels.add', 'Add') }}</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    <form method="post" class="register_form" action='{{ route('register.user') }}' id="">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Customer Name" id="combo_name"
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" placeholder="Mobile" id="combo_mobile"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="state" id="combo_state"
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="city" id="combo_city"
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" class="form-control" placeholder="address" id="combo_address"
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn reset-btn"
                                data-bs-dismiss="modal">{{ labels('admin_labels.cancel', 'Cancel') }}</button>
                            <button type="submit" name="register" value="save" class="btn btn-primary btn-sm submit_button"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" placeholder="Mobile" id="mobile"
                                            maxlength="16" oninput="validateNumberInput(this)" name="mobile" min='0'
                                            value="{{ old('mobile') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        <label class="form-label"
                                            for="address">{{ labels('admin_labels.address', 'Address') }}</label>
                                        <textarea type="text" class="form-control" placeholder="address" id="address"
                                            name="address" value="{{ old('address') }}"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control customer_mobile" placeholder="Mobile"
                                            maxlength="16" oninput="validateNumberInput(this)" id="mobile" name="mobile"
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        <label class="form-label"
                                            for="address">{{ labels('admin_labels.address', 'Address') }}</label>
                                        <textarea type="text" class="form-control customer_address" placeholder="address"
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" class="form-control combo_customer_name" placeholder="Customer Name"
                                        id="name" name="name" value="">
                                </div>
                                <div class="form-group">
                                    <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label"
                                                for="state">{{ labels('admin_labels.state', 'State') }}</label>
                                            <input type="text" class="form-control combo_customer_state" placeholder="state"
                                                id="state" name="state" value="{{ old('state') }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label"
                                                for="city">{{ labels('admin_labels.city', 'City') }}</label>
                                            <input type="text" class="form-control combo_customer_city" placeholder="city"
                                                id="city" name="city" value="">
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        <label class="form-label"
                                            for="address">{{ labels('admin_labels.address', 'Address') }}</label>
                                        <textarea type="text" class="form-control combo_customer_address"
    ...
    <script>
        window.posLabels = {
            please_wait: "{{ labels('panel_labels.please_wait', 'Please Wait...') }}",
            search_for_user: "{{ labels('panel_labels.search_for_user', 'Search for user') }}",
            search_for_customer: "{{ labels('panel_labels.search_for_customer', 'Search for customer') }}",
            loading_products: "{{ labels('panel_labels.loading_products', 'Please wait... loading products...') }}",
            show_products: "{{ labels('panel_labels.show_products', 'Show Products') }}",
            combo_item_already_in_cart: "{{ labels('panel_labels.combo_item_already_in_cart', 'Combo item already exists in cart') }}",
            combo_item_added_to_cart: "{{ labels('panel_labels.combo_item_added_to_cart', 'Combo item added to cart') }}",
            no_items_in_cart: "{{ labels('panel_labels.no_items_in_cart', 'No items in cart') }}",
            expand_more: "{{ labels('panel_labels.expand_more', 'Expand More') }}",
            expand_less: "{{ labels('panel_labels.expand_less', 'Expand Less') }}",
            no_products_available: "{{ labels('panel_labels.no_products_available', 'No products available...') }}",
            already_in_cart: "{{ labels('panel_labels.already_in_cart', 'Already in Cart') }}",
            item_already_in_cart_text: "{{ labels('panel_labels.item_already_in_cart_text', 'This item is already present in your cart') }}",
            product_added_to_cart: "{{ labels('panel_labels.product_added_to_cart', 'Product added to cart') }}",
            product_removed_from_cart: "{{ labels('panel_labels.product_removed_from_cart', 'Product removed from cart') }}",
            are_you_sure_checkout: "{{ labels('panel_labels.are_you_sure_checkout', 'Are you sure? Want to check out.') }}",
            please_add_items_to_cart: "{{ labels('panel_labels.please_add_items_to_cart', 'Please add items to the cart') }}",
            no_matching_seller_items: "{{ labels('panel_labels.no_matching_seller_items', 'There are no items matching your seller ID in the cart.') }}",
            processing: "{{ labels('panel_labels.processing', 'Processing') }}",
            add: "{{ labels('panel_labels.add', 'Add') }}",
            out_of_stock: "{{ labels('panel_labels.out_of_stock', 'Out of Stock') }}",
            items_in_cart: "{{ labels('panel_labels.items_in_cart', 'Items in Cart') }}",
            showing: "{{ labels('panel_labels.showing', 'Showing') }}",
            pagination_of: "{{ labels('panel_labels.pagination_of', 'of') }}",
            previous: "{{ labels('panel_labels.previous', 'Previous') }}",
            next: "{{ labels('panel_labels.next', 'Next') }}",
            discount_exceeds_total: "{{ labels('panel_labels.discount_exceeds_total', 'Discount value cannot be greater than total price!!') }}",
        };
    </script>
@endsection