                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="category_select" class="form-label">
                                ...
                                <span class='text-asterisks text-sm'>*</span>
                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                    data-bs-placement="right" data-bs-content="Select the category for this product."></i>
                            </label>
                        ...
                        <div class="form-group">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <label for="brand" class="form-label m-0">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                        data-bs-placement="right"
                                        data-bs-content="Select the brand for this product."></i>
                                </label>
                                <a href="{{ route('seller_brands.index') }}" target="_blank"
                    ...
                    <div class="col-md-6">
                        <div class="form-group country_list_div">
                            <label for="made_in" class="form-label">{{ labels('admin_labels.made_in', 'Made IN') }}
                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                    data-bs-placement="right"
                                    data-bs-content="Select the country where the product is made."></i>
                            </label>
                ...
                <div class="row">
                    <div class="col-md-6 d-none indicator">
                        <label for="indicator" class="form-label">{{ labels('admin_labels.indicator', 'Indicator') }}
                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                data-bs-placement="right" data-bs-content="Select if the product is Veg or Non-Veg."></i>
                        </label>
                    ...
                    <div class="col-md-6 hsn_code d-none">
                        <div class="form-group">
                            <label for="zipcodes" class="form-label">{{ labels('admin_labels.hsn_code', 'HSN Code') }}
                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                    data-bs-placement="right" data-bs-content="Enter the HSN code for the product."></i>
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="tags" class="form-label">
                                ...
                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                    data-bs-placement="right"
                                    data-bs-content="Enter tags for the product, separated by commas."></i>
                            </label>
                            ...
                            <div class="form-group">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <label for="pro_input_tax" class="form-label m-0">
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right"
                                            data-bs-content="Select applicable taxes for this product."></i>
                                    </label>
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    <label for="is_prices_inclusive_tax"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right"
                                            data-bs-content="Enable if tax is included in the product price."></i>
                                    </label>
                                </div>
                                <div class="d-flex">
                            ...
                            <div class="col-md-6 total_allowed_quantity">
                                <div class="form-group">
                                    <label for="total_allowed_quantity"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right"
                                            data-bs-content="Maximum quantity allowed for purchase."></i>
                                    </label>
                            ...
                            <div class="col-md-6 minimum_order_quantity">
                                <div class="form-group">
                                    <label for="minimum_order_quantity"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right"
                                            data-bs-content="Minimum quantity required for purchase."></i>
                                    </label>
                            ...
                            <div class="col-md-6 quantity_step_size">
                                <div class="form-group">
                                    <label for="quantity_step_size"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right"
                                            data-bs-content="Step size for quantity increments."></i>
                                    </label>
                            ...
                            <div class="col-md-6 warranty_period d-none">
                                <div class="form-group">
                                    <label for="warranty_period"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right"
                                            data-bs-content="Enter the warranty period if any."></i>
                                    </label>
                            ...
                            <div class="col-md-6 guarantee_period">
                                <div class="form-group">
                                    <label for="guarantee_period"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right"
                                            data-bs-content="Enter the guarantee period if any."></i>
                                    </label>
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    <label for="zipcode"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right"
                                            data-bs-content="Select the deliverable type for this product."></i>
                                    </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="zipcodes"
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Minimum order quantity for free delivery."></i>
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="zipcodes"
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                data-bs-placement="right"
                                                data-bs-content="Set the delivery charges for this product."></i>
                                        </label>
                                        <input type="number" min=1 class="form-control" value=""
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div id="affiliate_info" style="display:none;">
                                            <label for="is_in_affiliate"
                                                ...
                                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="Enable if this product is available for affiliate marketing."></i>
                                            </label>
                                        ...
                                        <div>
                                            <label for="is_cod_allowed"
                                                ...
                                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="Enable if cash on delivery is allowed for this product."></i>
                                            </label>
                                        </div>
                                        <div class="d-flex">
                                            <label for="" class="me-6 text-muted">[Enable/Disable]</label>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <label for="is_returnable"
                                                ...
                                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="Enable if this product can be returned."></i>
                                            </label>
                                        </div>
                                        <div class="d-flex">
                                            <label class="me-6 text-muted form-label">[Enable/Disable]</label>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <label for="is_cancelable"
                                                ...
                                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="Enable if this product can be canceled."></i>
                                            </label>
                                        </div>
                                        <div class="d-flex">
                                            <label class="me-6 text-muted form-label">[Enable/Disable]</label>
                            ...
                            <div class="col-md-6 mt-7 collapse" id='cancelable_till'>
                                <div class="form-group">
                                    <label for="cancelable_till"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right"
                                            data-bs-content="Select the status till which the product can be canceled."></i>
                                    </label>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <label for="is_attachment_required"
                                                ...
                                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="Enable if attachment is required for this product."></i>
                                            </label>
                                        </div>
                                        <div class="d-flex">
                                            <label class="me-6 text-muted form-label">[Enable/Disable]</label>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6 d-none" id="video_media_container">
                                    <label for="" class="form-label">Video<span
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right"
                                            data-bs-content="Upload the video for this product."></i>
                                    </label>
                                    <div class="form-group">
