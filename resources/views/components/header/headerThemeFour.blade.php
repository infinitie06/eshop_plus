                            ...
                            <div class="wishlist-link iconset">
                                <a wire:navigate href="{{ customUrl('my-account.favorites') }}"
                                    ...
                                    <span class="iconCot"><i class="anm anm-heart anm-heart-l hdr-icon icon"></i><span
                                            class="wishlist-count d-xl-none">{{ $wishlist_count }}</span></span>
                                    <span class="wishlist-count d-xl-none">{{ $wishlist_count }}</span>
                                    <small class="favorite_count">{{ $wishlist_count }} Item</small>
                                </a>
                            </div>
                        @endauth
                        <!--End Wishlist-->
