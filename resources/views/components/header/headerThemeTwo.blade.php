<div>
    ...
    <div>
                            ...
                            @if (count($currencies) > 1)
                                <ul class="select-ul">
                                    @foreach ($currencies as $currency)
                                        <li class="option USD changeCurrency"
        ...
        @auth
            ...
            @endphp
        @endauth
        <header class="header header-7" style="margin-bottom: 0 !important; padding-bottom: 0 !important;">
            <!--Header inner-->
            <div class="header-main d-flex align-items-center">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <!--Right Icon-->
                        <div
                            class="col-4 col-sm-4 col-md-5 col-lg-9 col-xl-10 align-self-center icons-col d-flex justify-content-end">
                            <!--search-->
                            ...
                            @auth
                                <div class="wishlist-link iconset">
                                    <a wire:navigate href="{{ customUrl('my-account.favorites') }}"
                                        ...
                                        <span
                                            class="text d-none d-xl-flex flex-column text-left">{{ labels('front_messages.wishlist', 'Wishlist') }}
                                            <small class="favorite_count">{{ $favorites['favorites_count'] }}
                                                {{ labels('front_messages.item', 'Item') }}</small></span>
                                    </a>
                                </div>
                            @endauth
                            <!--End Wishlist-->
                                    ...
                                    <div id="accountBox">
                                        <div class="customer-links">
                                            <ul class="m-0">
                                                ...
                                                @else
                                                    <li><a href="{{ customUrl('login') }}"><i
                                                                class="anm anm-arrow-al-right anm-user-al hdr-icon icon"></i>{{ labels('front_messages.sign_in', 'Sign In') }}</a>
                                                    </li>
                                                    <li><a href="{{ customUrl('register') }}"><i
                                                                class="hdr-icon icon anm anm-user-al"></i>{{ labels('front_messages.register', 'Register') }}</a>
                                                    </li>
                                                @endauth
                                            </ul>
                            ...
                            <div class="col-1 col-sm-1 col-md-1 col-lg-3 align-self-center">
                                <div class="header-vertical-menu toggle">
                                    <h4 class="menu-title theme_four_header_menu_title d-flex-center body-font">
                                        ...
                                        <span
                                            class="text">{{ labels('front_messages.browse_categories', 'Browse Categories') }}</span>
                                    </h4>
                                    <div class="vertical-menu-content rounded-4 rounded-top-0">
                                        ...
                                        <a wire:navigate href="{{ customUrl('categories') }}"
                                            ...
                                            <span>{{ labels('front_messages.view_all_categories', 'View All Categories') }}</span>
                        ...
                        <ul class="list-inline social-icons mt-3">
                            @if ($settings->twitter_link !== null)
                                <li class="list-inline-item"><a href="{{ $settings->twitter_link }}"
                                        data-bs-toggle="tooltip" data-bs-placement="top" title="X (Twitter)"
                                        target="_blank"><i class="fa-brands fa-x-twitter hdr-icon icon"></i></a></li>
                            @endif
        ...
        @if (isset($stores) && count($stores) >= 2)
            <div class="sticky-stores">
                <div class="stores-main">
                    <div class="in-out-store-arrow store-show">
