<div class="template-index index-demo9">
    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-8 col-sm-6 col-md-4 col-lg-4 text-left">
                <div class="select-wrap language-picker float-start d-lg-none">
                ...
                @php
                    ...
                    $is_shiprocket_enabled = isset($shipping_settings['shiprocket_shipping_method']) && $shipping_settings['shiprocket_shipping_method'] == 1;
                @endphp
    ...
    <header class="header header-9">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-4 col-sm-4 col-md-5 col-lg-5 col-xxl-5 align-self-center icons-col text-left">
                        <!--Mobile Toggle-->
                        <button type="button"
                            class="iconset ps-0 menu-icon js-mobile-nav-toggle mobile-nav--open d-lg-none"
                            data-bs-toggle="tooltip" data-bs-placement="top" title=""
                            data-bs-original-title="Menu" aria-label="Menu"><i
                                class="hdr-icon icon anm anm-times-l"></i><i
                                class="hdr-icon icon anm anm-bars-r"></i></button>
                        <!--End Mobile Toggle-->
                        <div class="select-wrap language-picker float-start d-none d-lg-block">
                            <ul class="default-option">
                                <li>
                                    <div class="option english">
                                        <span>{{ session('locale') ?? ($languages[0]->code ?? 'en') }}</span>
                        ...
                        @if (!$is_shiprocket_enabled)
                            <div class="select-wrap currency-picker float-start d-none d-lg-block">
                                <ul class="default-option">
                                    <li>
                                        <div class="option USD">
                                            <span>{{ session('currency') ?? ($system_settings['currency_setting']['code'] ?? 'USD') }}</span>
                    ...
                    <div class="logo col-4 col-sm-4 col-md-2 col-lg-2 col-xxl-2 align-self-center text-center">
                        <a wire:navigate class="logoImg" href="{{ customUrl('home') }}"><img class="mx-auto"
        ...
        <!--End Header inner-->
        <!--Navigation Desktop-->
        <div class="main-menu-outer d-none d-lg-block header-fixed" style="">
            <div class="container-fluid">
                ...
                <div class="mobile-links">
                    <ul class="list-inline d-inline-flex flex-column w-100">
                        ...
                        @else
                            ...
                            <li><a href="{{ customUrl('register') }}" wire:navigate class="d-flex align-items-center">
                                    <<i class="hdr-icon icon anm anm-user-al">
                                        </i>{{ labels('front_messages.register', 'Register') }}
                                </a>
                            </li>
                        @endauth
