            ...
            <div class="row">
                ...
                <div class="col-7 col-sm-9 col-md-9 col-lg-2 align-self-center icons-col text-right">
                    ...
                    <div class="search-parent iconset">
                        <div class="site-search" title="{{ labels('front_messages.search', 'Search') }}">
                    ...
                    <div class="account-parent iconset">
                        <div class="account-link" title="{{ labels('front_messages.account', 'Account') }}"><i class="hdr-icon icon anm anm-user-al"></i></div>
                        <div id="accountBox">
                    ...
                    @auth
                        ...
                        @endphp
                        <!--Wishlist-->
                        <div class="wishlist-link iconset" title="{{ labels('front_messages.wishlist', 'Wishlist') }}"><a wire:navigate
                    ...
                    @endauth
                    <!--Minicart-->
                    <div class="header-cart iconset" title="{{ labels('front_messages.cart', 'Cart') }}">
                    ...
                    <button type="button"
                        ...
                        title="{{ labels('front_messages.menu', 'Menu') }}"><ion-icon wire:ignore class="fs-5" name="menu"></ion-icon></button>
                    <!--End Mobile Toggle-->
                </div>
                <!--End Right Icon-->
            </div>
