...
<nav class="navbar-vertical navbar bg-white" {{ session()->get('is_rtl') == 1 ? 'dir=rtl' : '' }}>
    <div class="nav-scroller bg-white">
        ...
        <ul class="navbar-nav" id="menuList">
            ...
            <li class="nav-item ">
                <a class="nav-link {{ Request::is('seller/stores') || Request::is('seller/stores/*') ? 'active' : '' }}"
                    href="{{ route('seller.stores.index') }}">
                    <span class="nav-link-text ">{{ labels('admin_labels.stores', 'Stores') }}</span>
                </a>
            </li>
            <li class="nav-item ">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('seller/manage_combo_stock') || Request::is('seller/manage_combo_stock/*') ? 'active' : '' }}"
                    ...
                    <span
                        class="nav-link-text">{{ labels('admin_labels.combo_stock_manage', 'Combo Stock Manage') }}</span>
                </a>
            </li>
            <li class="nav-item ">
             ...
             <li class="nav-item ">
                <a class="nav-link {{ Request::is('seller/manage_product_pickup_locations') || Request::is('seller/manage_product_pickup_locations/*') ? 'active' : '' }}"
                    href="{{ route('seller.product.pickup_locations') }}">
                    <span
                        class="nav-link-text ">{{ labels('admin_labels.manage_product_pickup_locations', ' Product Pickup Locations') }}</span>
                </a>
            </li>
            <li class="nav-item ">
            ...
            <li class="nav-item ">
                <a class="nav-link manage_product_deliverability {{ Request::is('seller/manage_combo_product_pickup_locations') || Request::is('seller/manage_combo_product_pickup_locations/*') ? 'active' : '' }}"
                    href="{{ route('seller.combo_product.pickup_locations') }}">
                    <span
                        class="nav-link-text ">{{ labels('admin_labels.manage_combo_product_pickup_locations', 'Combo Product Pickup Locations') }}</span>
                </a>
            </li>
