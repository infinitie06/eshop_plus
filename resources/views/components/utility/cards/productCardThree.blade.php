                ...
                @if ($details->best_seller || $details->new_arrival)
                    ...
                    @if ($details->best_seller)
                        <div class="product-labels"><span
                                class="lbl pr-label2 rounded-pill">{{ labels('front_messages.best_seller', 'Best Seller') }}</span>
                        </div>
                    @endif
                    @if ($details->new_arrival)
                        <div class="product-labels"><span
                                class="lbl pr-label2 rounded-pill">{{ labels('front_messages.new_arrivals', 'New Arrival') }}</span>
                        </div>
                    @endif
