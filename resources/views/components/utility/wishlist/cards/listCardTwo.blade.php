                                ...
                                <div class="grid-products grid-view-items">
                                    <div class="col-row row row-cols-2 row-cols-lg-4 row-cols-md-3 row-cols-xl-5">
                                        @foreach ($regular_wishlist as $details)
                                            @php
                                                $pro_image = app(MediaService::class)->dynamic_image(
                                                    $details['image'],
                                                    800,
                                                );
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box position-relative">
                                                    <button type="button"
                                                        wire:click="removeFavorite({{ $details['id'] }})"
                                                        class="btn remove-icon close-btn" title="Remove">
                                                    ...
                                                    <div class="product-details text-center">
                                                        ...
                                                        <div class="product-price">
                                                            @php
                                                                $price = app(
                                                                    CurrencyService::class,
                                                                )->currentCurrencyPrice($details['price'], true);
                                                                $special_price =
