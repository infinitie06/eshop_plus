                        ...
                        <div class="col-md-12">
                            ...
                            @for ($i = 0; $i < count($invoice->seller->custom_fields['seller_ids']); $i++)
                                @php
                                    ...
                                    $seller_signature = app(MediaService::class)->getMediaImageUrl(
                                        $seller_data[0]->authorized_signature,
                                        'SELLER_IMG_PATH',
                                    );
                                    $seller_logo = app(MediaService::class)->getMediaImageUrl(
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($invoice->getCustomData() as $row)
                                                                ...
                                                                @php
                                                                    ...
                                                                    )->getVariantsValuesById($row->product_variant_id);
                                                                    $product_variants =
                                                                    ...
                                                                    // Use discounted price if available and lower than price
                                                                    $price_per_unit =
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        $tax_amount =
                                                                            $price_per_unit * ($row->tax_percent / 100);
                                                                    }
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        $sub_total_item =
                                                                            floatval($price_per_unit) * $row->quantity;
                                                                    } else {
                                                                        $sub_total_item =
                                                                            floatval($price_per_unit + $tax_amount) *
                                                                            $row->quantity;
                                                                    }

                                                                    // Update totals
                                                                    $total += $sub_total_item; // Consistent with other logic if used
                                                                    $quantity += floatval($row->quantity);
                                                                    $total_tax +=
                                                                        floatval($tax_amount) * $row->quantity;

                                                                    $price_without_tax = $price_per_unit - $tax_amount;
                                                                    $sub_total = $sub_total_item; // Used for display
                                                        ...
                                                        <table class="table borderless text-sm text-right">
                                                            ...
                                                            @if (isset($invoice->buyer->custom_fields['promo_code']))
                                                                <tr>
                                                                    ...
                                                                    <td>-
                                                                        @php
                                                                            $promo_discount = isset(
                                                                                $order_caharges_data[0]->promo_discount,
                                                                            )
                                                                                ? $order_caharges_data[0]
                                                                                    ->promo_discount
                                                                                : 0;
                                                                            echo formatePriceDecimal($promo_discount);
