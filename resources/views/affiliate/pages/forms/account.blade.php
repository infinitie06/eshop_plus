...
@endsection
@section('content')
      <x-affiliate.breadcrumb :title="labels('admin_labels.account_setting', 'Account Setting')" :subtitle="labels(
    ...
    <div class="col-md-12 col-xxl-6">
        <div class="card">
            <div class="card-body">
                <form id="validationForm" method="POST" action="/affiliate/users/update/{{ auth()->user()->id }}"
                    ...
                    <div class="row mt-8">
                        <div class="col-md-12 text-center">
                         <input type="file" class="filepond" name="image" data-max-file-size="30MB" accept="image/*,.webp" />
