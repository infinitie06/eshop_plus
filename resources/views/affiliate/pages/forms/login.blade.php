                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <h1 class="font-weight-bolder">
                                    {{ labels('panel_labels.affiliate_login', 'Affiliate Login') }}</h1>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select select-country-code" id="country_code"
                                            name="country_code" style="max-width: 65px;">
                            ...
                            <div class="d-flex justify-content-center">
                                <span>{{ labels('panel_labels.dont_have_account', "Don't have any account?") }}</span>
                                <a target="_blank" href="{{ route('affiliate.register') }}"
                                    class="mx-2">{{ labels('panel_labels.sign_up', 'Sign Up') }}</a>
                            </div>
                        </div>
                    </div>
