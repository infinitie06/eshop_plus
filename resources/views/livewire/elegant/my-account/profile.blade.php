                ...
                <div class="dashboard-content h-100">
                    ...
                    <div class="h-100" id="profile">
                        <div class="profile-card mt-0 h-100">
                            ...
                            <!-- Edit Profile Modal -->
                            @php
                                $user_img = app(MediaService::class)->getMediaImageUrl($user_info->image);
                                $user_img = app(MediaService::class)->dynamic_image($user_img, 140);
                            @endphp
                            <div wire:ignore.self class="modal fade" id="editProfileModal" tabindex="-1"
                                aria-labelledby="editProfileModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                                                ...
                                                <div class="form-row">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="thumb-edit">
                                                                <label for="profile_upload"
                                                                    ...
                                                                    title="{{ labels('front_messages.edit', 'Edit') }}"><ion-icon wire:ignore
                                                    ...
                                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                                        ...
                                                        <input name="editProfile-streetaddress"
                                                            placeholder="{{ labels('front_messages.street_address', 'Street address') }}"
                                                    ...
                                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                                        ...
                                                        <input name="edit-zipcode" placeholder="{{ labels('front_messages.zip_code', 'Zip code') }}"
                            ...
                            <div class="modal fade" id="editLoginModal" tabindex="-1"
                                aria-labelledby="editLoginModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                                                ...
                                                <div
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="editLogin-Password"
                                                            placeholder="{{ labels('front_messages.current_password', 'Current Password') }}" value=""
                                                    ...
                                                    <div class="form-group">
                                                        <label for="editLogin-NewPassword"
                                                            ...
                                                            <span class="required">*</span></label>
                                                        <input name="editLogin-NewPassword" placeholder="{{ labels('front_messages.new_password', 'New Password') }}"
                                                    ...
                                                    <div class="form-group mb-0">
                                                        <label for="editLogin-Verify"
                                                            class="d-none">{{ labels('front_messages.verify_password', 'Verify Password') }}<span
                                                                class="required">*</span></label>
                                                        <input name="editLogin-Verify" placeholder="{{ labels('front_messages.verify_password', 'Verify Password') }}"
