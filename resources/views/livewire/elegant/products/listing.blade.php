...
<div id="page-content">
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="breadcrumbs"><a wire:navigate href="{{ customUrl('/') }}"
                                title="{{ labels('front_messages.back_to_home_page', 'Back to the home page') }}">{{ labels('front_messages.home', 'Home') }}</a>
                    ...
                    <div class="sidebar-tags sidebar-sticky clearfix">
                        ...
                        @if ($products_type == 'regular')
                            @if (count($brands) >= 1 && count($products_listing) < 1)
                                <div class="sidebar-widget filterBox filter-widget brand-filter">
                                    <div class="widget-title">
                                        <h2>{{ labels('front_messages.brands', 'Brands') }}</h2>
                                    </div>
                                    <div class="widget-content filterDD">
                                        <ul class="clearfix">
                                            <ul class="sidebar-categories scrollspy morelist clearfix">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div
                                ...
                                <div class="filters-item d-flex align-items-center ms-2 ms-lg-3">
                                    ...
                                    <select name="perPage" id="perPage" class="filters-toolbar-perPage me-2" wire:model.live="perPage">
                        ...
                        <div
                            ...
                            @foreach ($products_listing as $details)
                                ...
                                <div wire:ignore.self>
                                    ...
                                    <div wire:key="product-{{ $details->id }}">
    ...
    <input type="hidden" name="min-price" id='min-price'
        value="{{ app(CurrencyService::class)->currentCurrencyPrice($min_max_price['min_price']) }}">
    <input type="hidden" name="max-price" id='max-price'
        value="{{ app(CurrencyService::class)->currentCurrencyPrice($min_max_price['max_price']) }}">
    <input type="hidden" name="selected_max_price" id='selected_max_price'
        value="{{ app(CurrencyService::class)->currentCurrencyPrice($min_max_price['selected_max_price']) }}">
    <input type="hidden" name="selected_min_price" id='selected_min_price'
        value="{{ app(CurrencyService::class)->currentCurrencyPrice($min_max_price['selected_min_price']) }}">
</div>
