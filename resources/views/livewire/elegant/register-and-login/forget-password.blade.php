                        ...
                        <div class="send-otp-box">
                            ...
                            <div class="form-row">
                                <div class="form-group col-12 mb-4 d-flex flex-column">
                                    ...
                                    <input type="number" name="number" placeholder="{{ labels('front_messages.enter_your_mobile_number', 'Enter your Mobile Number') }}"
                                        id="number" data-default-country="{{ $default_country ?? 'eg' }}" value="" required />
                        ...
                        <div class="verify-otp-box d-none">
                            <div class="form-row">
                                <div class="form-group col-12 mb-4 d-flex flex-column">
                                    ...
                                    <input type="number" name="verificationCode" placeholder="{{ labels('front_messages.verification_code', 'Verification Code') }}"
                                ...
                                <div class="form-group col-12 mb-0">
                                    <div
                                        ...
                                        <input type="submit" id="verify_otp" class="btn btn-primary btn-lg"
                                            value="{{ labels('front_messages.verify_otp', 'Verify OTP') }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group col-12 mb-0">
                                    <div
                                        ...
                                        <input type="submit" id="changePassword" class="btn btn-primary btn-lg"
                                            value="{{ labels('front_messages.change_password', 'Change Password') }}" />
                                    </div>
                                </div>
                            </div>
                        </form>
