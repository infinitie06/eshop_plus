                                    ...
                                    <div class="form-group">
                                        <div class="card-body p-0">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control addr_editor"name="admin_privacy_policy" placeholder="{{ labels('admin_labels.privacy_policy_placeholder', 'Privacy Policy') }}" rows="5">{{ isset($admin_privacy_policy['admin_privacy_policy']) ? $admin_privacy_policy['admin_privacy_policy'] : '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="card-body p-0">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control addr_editor"name="admin_terms_and_conditions" placeholder="{{ labels('admin_labels.terms_and_conditions_placeholder', 'Terms and Conditions') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a href="{{ route('seller_terms_and_conditions.view') }}" target="_blank"
                                                    class="p-2 badge bg-gradient-info" title="{{ labels('admin_labels.view_terms_and_condition', 'View Terms & Condition') }}"><i
                                                        class="fa fa-eye"></i></a>
                                                <textarea class="form-control addr_editor"name="seller_terms_and_conditions" placeholder="{{ labels('admin_labels.terms_and_conditions_placeholder', 'Terms and Conditions') }}"
