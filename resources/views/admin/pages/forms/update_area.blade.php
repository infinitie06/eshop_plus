            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">{{ labels('admin_labels.update_area_title', 'Update Area') }}</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                ...
                                <form action="{{ url('/admin/area/update/' . $data->id) }}" enctype="multipart/form-data"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="area_name" class="control-label">{{ labels('admin_labels.area_name_label', 'Area Name') }} <span
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="zipcode" class="control-label">{{ labels('admin_labels.zipcode_th', 'Zipcode') }} <span
                                                            class='text-danger text-xs'>*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="minimum_free_delivery_order_amount"
                                                        class="control-label">{{ labels('admin_labels.minimum_free_delivery_order_amount_label', 'Minimum Free Delivery Order Amount') }} <span
                                                            class='text-danger text-xs'>*</span></label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="delivery_charges" class="control-label">{{ labels('admin_labels.delivery_charges_label', 'Delivery Charges') }}
                                    ...
                                    <div class="mb-3 d-flex justify-content-start">
                                        <button type="submit" class="btn btn-sm btn-primary" id="">{{ labels('admin_labels.update_option', 'Update') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
