    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="mb-3">
                        {{ labels('admin_labels.add_blog_heading', 'Add Blog') }}
                    </h5>
                    <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <div class="tab-content mt-3" id="brandTabsContent">
                                            <div class="tab-pane fade show active" id="content-en" role="tabpanel"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" placeholder="{{ labels('admin_labels.title_placeholder', 'Title') }}" name="title"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12 get_blog_category_parent">
                                                ...
                                                <select name="category_id" class="form-select get_blog_category"
                                                    data-placeholder="{{ labels('admin_labels.search_categories', 'Search Categories') }}">
                                                    <option></option>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <textarea name="short_description" class="form-control" rows="3"
                                            placeholder="{{ labels('admin_labels.short_description_for_blog_cards_placeholder', 'Short description for blog cards (plain text)') }}"></textarea>
                                        <small
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <label for=""
                                            class="form-label">{{ labels('admin_labels.description', 'Description') }}<span
                                                class="text-asterisks text-sm">*</span></label>
                                        <textarea name="description" class="form-control textarea addr_editor" placeholder="{{ labels('admin_labels.place_some_text_here', 'Place some text here') }}"></textarea>
                                        <small
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                    <div class="input-group me-2 search-input-grp ">
                                        ...
                                        <input type="text" data-table="admin_blog_table"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('admin_blog_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button></li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('admin_blog_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button></li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('admin_blog_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button></li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('admin_blog_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
