                            ...
                            <div class="tab-content mt-3" id="UpdatebrandTabsContent">
                                ...
                                <div class="tab-pane fade show active" id="content-en" role="tabpanel"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ labels('admin_labels.title_placeholder', 'Title') }}" name="title"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="discount_type" class="form-control form-select discount_type">
                                    <option value="percentage"
                                        ...
                                        {{ labels('admin_labels.percentage_option', 'Percentage') }}</option>
                                    <option value="amount"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="repeat_usage" id="repeat_usage" class="form-control form-select">
                                    <option value="1"
                                        ...
                                        {{ labels('admin_labels.allowed_option', 'Allowed') }}</option>
                                    <option value="0"
                                        {{ isset($data->repeat_usage) && $data->repeat_usage == '0' ? 'selected' : '' }}>
                                        {{ labels('admin_labels.not_allowed_option', 'Not Allowed') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status" id="status" class="form-control form-select">
                                    ...
                                    <option value="1"
                                        {{ isset($data->status) && $data->status == '1' ? 'selected' : '' }}>{{ labels('admin_labels.active_users', 'Active') }}
                                    </option>
                                    <option value="0"
                                        {{ isset($data->status) && $data->status == '0' ? 'selected' : '' }}>{{ labels('admin_labels.deactive_users', 'Deactive') }}
                                    </option>
                                </select>
                            </div>
                                                ...
                                                <div class="mt-2">
                                                    <div class="col-md-12  text-center">
                                                        <div>
                                                            ...
                                                            <p class="image_recommendation">{{ labels('admin_labels.recommended_size_147x60', 'Recommended Size: 147 x 60 pixels') }}
                                                            </p>
                                                        </div>
