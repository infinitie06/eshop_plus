            ...
            <div class="col-xxl-12 p-0">
                <div class="row cols-5 d-flex">
                    ...
                    <div class="col-md-12 col-xl-9 mt-md-2 mt-sm-2 mt-xl-0">
                        ...
                        @endif
                        <form action="{{ route('admin.products.update', $data->id) }}" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="col col-xxl-6">
                                        <div class="card p-5">
                                            ...
                                            <select class='form-control form-select mt-4' name='seller_id' id="seller_id">
                                                <option value="">{{ labels('admin_labels.select_seller_dropdown', 'Select Seller') }}</option>
                                                @foreach ($sellers as $seller)
                                                    <option value="{{ $seller->id }}"
                                                        @if (isset($data->seller_id) && $data->seller_id == $seller->id) selected @endif>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-select admin_product_brand_list"
                                                            id="admin_product_brand_list   " name="brand">
                            ...
                            <div class="ml-2 card2">
                                ...
                                <div class="float-end ml-2 mt-xxl-3 mt-7 next-button text-center" data-step="step3">
                                    <button type="button" class="btn btn-primary ">{{ labels('admin_labels.next_step', 'Next') }}</button>
                                </div>
                            </div>
                                                                                        ...
                                                                                        <div class="col-6">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="number"
                                                                                                    class="form-control"
                                                                                                    name="weight"
                                                                                                    placeholder="{{ labels('admin_labels.weight_placeholder', 'Weight') }}"
                                                                                                    id="weight"
                                                                                        ...
                                                                                        <div class="col-6">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="number" min=0
                                                                                                    class="form-control"
                                                                                                    name="height"
                                                                                                    placeholder="{{ labels('admin_labels.height_placeholder', 'Height') }}"
                                                                                                    id="height"
                                                                                        ...
                                                                                        <div class="col-6">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="number" min=0
                                                                                                    class="form-control"
                                                                                                    name="breadth"
                                                                                                    placeholder="{{ labels('admin_labels.breadth_placeholder', 'Breadth') }}"
                                                                                                    id="breadth"
                                                                                        ...
                                                                                        <div class="col-6">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="number" min=0
                                                                                                    class="form-control"
                                                                                                    name="length"
                                                                                                    placeholder="{{ labels('admin_labels.length_placeholder', 'Length') }}"
                                                                                                    id="length"
                                                                        ...
                                                                        <div class="form-group <?= intval($data->stock_type) > 0 ? '' : 'collapse' ?>"
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <select id="stock_level_type"
                                                                                    ...
                                                                                    data-placeholder="{{ labels('admin_labels.type_to_search_and_select_type', 'Type to search and select type') }}">
                                                                                    <option value=" ">{{ labels('admin_labels.select_stock_type_option', 'Select Stock Type') }}
                                                                                    </option>
                                                                    ...
                                                                    <div class="col-md-6 d-flex">
                                                                        ...
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" name="download_allowed"
                                                                                id="download_allowed"
                                                                        ...
                                                                        <div class="row mt-3 image-upload-section">
                                                                            <div
                                                                                ...
                                                                                <div class='image-upload-div'><img
                                                                                        ...
                                                                                        alt="{{ labels('admin_labels.product_file_alt', 'Product File') }}"
                                                                                        title="{{ labels('admin_labels.product_file_alt', 'Product File') }}">
                                                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <p class="caption text-muted mt-2">(Recommended Size : 180 x
                                                            180
                                                            pixels)</p>
                                                        <div class="row mt-3 image-upload-section">@php
                                        ...
                                        <div class="card p-5">
                                            ...
                                            <div class="row mt-5">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea name="pro_input_description" class="form-control addr_editor" placeholder="{{ labels('admin_labels.place_some_text_here', 'Place some text here') }}">{{ isset($data->description) ? $data->description : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="row mt-5">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea name="extra_input_description" class="form-control addr_editor" placeholder="{{ labels('admin_labels.place_some_text_here', 'Place some text here') }}">{{ isset($data->extra_description) ? $data->extra_description : '' }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
