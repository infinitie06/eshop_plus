                                    ...
                                    <div class="mb-3">
                                        <label for="title" class="form-label">
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1"
                                               ...
                                               data-bs-content="{{ labels('admin_labels.enter_descriptive_promo_title', 'Enter a descriptive title for the promo code.') }}"></i>
                                        </label>
                                        <input type="text" placeholder="{{ labels('admin_labels.title_placeholder', 'Title') }}" name="title" class="form-control"
                                            value="{{ old('title') }}">
                                    </div>
                                    <div class="col-md-12">
                                        <label for="description" class="control-label mb-2 mt-2">
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1"
                                               data-bs-toggle="popover"
                                               data-bs-placement="right"
                                               data-bs-content="{{ labels('admin_labels.promo_message_shown_to_users', 'This message will be shown to users when they apply the promo code.') }}"></i>
                                        </label>
                                        <input type="text" class="form-control" name="message" id="message"
                                            value="" placeholder="{{ labels('admin_labels.placeholder_message', 'Message') }}">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <label class="mb-2 mt-2" for="">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.enter_actual_promo_code', 'Enter the actual promo code users will use.') }}"></i>
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.select_promo_start_date_help', 'Select the date when the promo code becomes active.') }}"></i>
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.select_promo_end_date_help', 'Select the date when the promo code expires.') }}"></i>
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.max_users_promo_use_help', 'Maximum number of users who can use this promo code.') }}"></i>
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.min_order_value_promo_help', 'Minimum order value required to apply this promo code.') }}"></i>
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.choose_percentage_or_fixed_discount_help', 'Choose whether the discount is a percentage or a fixed amount.') }}"></i>
                                </label>
                                <select name="discount_type" class="form-control form-select discount_type">
                                    ...
                                    <option value="percentage">{{ labels('admin_labels.percentage_option', 'Percentage') }}</option>
                                    <option value="amount">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.enter_discount_value_help', 'Enter the discount value (percentage or amount).') }}"></i>
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.max_discount_amount_help', 'Maximum discount amount that can be applied.') }}"></i>
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.allow_multiple_promo_use_help', 'Allow users to use the promo code multiple times.') }}"></i>
                                </label>
                                <select name="repeat_usage" id="repeat_usage" class="form-control form-select">
                                    <option value="">
                                        {{ labels('admin_labels.select', 'Select') }}
                                    </option>
                                    <option value="1">{{ labels('admin_labels.allowed_option', 'Allowed') }}</option>
                                    <option value="0">{{ labels('admin_labels.not_allowed_option', 'Not Allowed') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.set_promo_active_inactive_help', 'Set the promo code as active or inactive.') }}"></i>
                                </label>
                                <select name="status" id="status" class="form-control form-select">
                                    <option value="">
                                        {{ labels('admin_labels.select', 'Select') }}
                                    </option>
                                    <option value="1">{{ labels('admin_labels.active_users', 'Active') }}</option>
                                    <option value="0">{{ labels('admin_labels.deactive_users', 'Deactive') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6 mb-4">
                                <label class="mb-2 mt-2" for="image" class="mb-2">
                                    {{ labels('admin_labels.image', 'Image') }}
                                    <span class='text-asterisks text-sm'>*</span>
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.upload_promo_image_recommended_help', 'Upload an image for the promo code. Recommended size: 147 x 60 pixels.') }}"></i>
                                </label>
                                <div class="col-md-12">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_promocode_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_promocode_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_promocode_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_promocode_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
