                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="offer_ids[]" id="offer_sliders_offer"
                                            ...
                                            <div class="mt-2">
                                                <div class="col-md-12  text-center">
                                                    <div>
                                                        ...
                                                        <p class="image_recommendation">{{ labels('admin_labels.recommended_size_131x131', 'Recommended Size: 131 x 131 pixels') }}</p>
                                                    </div>
