...
@section('content')
    ...
    @endphp
    <x-admin.breadcrumb :title="labels('admin_labels.add_product', 'Update Product')" :subtitle="labels('admin_labels.add_products_with_power_and_simplicity', 'Add products with power and simplicity')" :breadcrumbs="[
                            ...
                            <div class="col-md-4">
                                ...
                                <select class='form-control disabled form-select mt-4' name='seller_id' id="seller_id">
                                    @foreach ($sellers as $seller)
                                        @php
                                            $userId = $seller->pivot->user_id ?? null;
                                            $username = \App\Models\User::find($userId)?->username ?? 'Unknown';
                                        @endphp
                                        <option value="{{ $seller->id }}"
                                            {{ isset($data->seller_id) && (string) $data->seller_id === (string) $seller->id ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="form-control" placeholder="{{ labels('admin_labels.gucci_placeholder', 'Gucci') }}" id="pro_input_text"
                                            name="pro_input_name"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <textarea class="form-control" id="short_description" placeholder="{{ labels('admin_labels.product_short_description_placeholder', 'Product Short Description') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="language_custom_prompt_{{ $lang->code }}" class="form-control mt-2 d-none custom_translated_prompt"
                                                    name="custom_translated_prompt" placeholder="{{ labels('admin_labels.placeholder_custom_ai_prompt', 'Enter your own AI prompt (optional)...') }}"></textarea>
                                                <div class="position-relative w-100">
                                                    <div
                                                ...
                                                <textarea class="form-control" id="translated_short_description_{{ $lang->code }}"
                                                    placeholder="{{ labels('admin_labels.product_short_description_placeholder', 'Product Short Description') }}" name="translated_product_short_description[{{ $lang->code }}]">{{ isset($data->short_description) ? json_decode($data->short_description, true)[$lang->code] ?? '' : '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 d-none hsn_code">
                            <div class="form-group">
                                ...
                                <input type="text" class="col-md-12 form-control" name="hsn_code"
                                    value="{{ isset($data->hsn_code) ? $data->hsn_code : '' }}" placeholder="{{ labels('admin_labels.hsn_code_placeholder', 'HSN Code') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tags"
                                    placeholder="{{ labels('admin_labels.tags_placeholder_example', 'dress,milk,almond') }}" name="tags"
                                ...
                                <div class="col-md-6 total_allowed_quantity">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="col-md-12 form-control"
                                            ...
                                            placeholder="{{ labels('admin_labels.placeholder_total_allowed_quantity', 'Total Allowed Quantity') }}"
                                            {{ $data->type == 'digital_product' ? 'disabled' : '' }}>
                                ...
                                <div class="col-md-6 minimum_order_quantity">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="col-md-12 form-control"
                                            ...
                                            placeholder="{{ labels('admin_labels.placeholder_minimum_order_quantity', 'Minimum Order Quantity') }}"
                                            {{ $data->type == 'digital_product' ? 'disabled' : '' }}>
                                ...
                                <div class="col-md-6 quantity_step_size">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="col-md-12 form-control" name="quantity_step_size"
                                            ...
                                            placeholder="{{ labels('admin_labels.placeholder_quantity_step_size', 'Quantity Step Size') }}"
                                            {{ $data->type == 'digital_product' ? 'disabled' : '' }}>
                                ...
                                <div class="col-md-6 d-none warranty_period">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="col-md-12 form-control" name="warranty_period"
                                            ...
                                            placeholder="{{ labels('admin_labels.warranty_period_if_any', 'Warranty Period if any') }}">
                                ...
                                <div class="col-md-6 d-none guarantee_period">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="col-md-12 form-control" name="guarantee_period"
                                            ...
                                            placeholder="{{ labels('admin_labels.guarantee_period_if_any', 'Guarantee Period if any') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select deliverable_type" name="deliverable_type"
                                            ...
                                            <option class="all_deliverable_type" value="1"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="shipping_type"
                                            class="form-label">{{ labels('admin_labels.for_standard_shipping', 'For Standard Shipping') }}</label>
                                        <select class='form-control shiprocket_type form-select' name="pickup_location"
                                            ...
                                            @foreach ($shipping_data as $val)
                                                <option value="{{ $val->id }}"
                                                    @if ($val->id == $pickup_location) selected @endif>
                                                    {{ $val->pickup_location }}
                                                </option>
                                            @endforeach
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div id="affiliate_info" style="display:none;">
                                                ...
                                                <i class="fas fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    ...
                                                    data-bs-content="{{ labels('admin_labels.affiliate_category_popover_text', 'If your selected category has been marked by the admin as available for affiliate, only then you can mark the product as an affiliate product. Otherwise, this option will be disabled.') }}">
                                                </i>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="is_in_affiliate" name="is_in_affiliate"
                                ...
                                <div class="col-md-12 additional-info existing-additional-settings">
                                            ...
                                            <div class="align-items-center d-flex form-group justify-content-end">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="type" id="product-type"
                                                        ...
                                                        data-placeholder="{{ labels('admin_labels.type_to_search_and_select_type', 'Type to search and select type') }}" disabled>
                                                        <option value="">
                                    ...
                                    <div id="attributes_values_json_data" class="d-none">
                                        <select class="select_single"
                                            data-placeholder="{{ labels('admin_labels.type_to_search_and_select_attributes', 'Type to search and select attributes') }}">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-6 {{ isset($data->video_type) && ($data->video_type == 'youtube' || $data->video_type == 'vimeo') ? '' : 'd-none' }}"
                                        ...
                                        <input type="text" class="form-control" name="video" id="video"
                                            ...
                                            placeholder="{{ labels('admin_labels.paste_youtube_vimeo_video_link_url', 'Paste Youtube / Vimeo Video link or URL here') }}">
                                    </div>
                                    ...
                                    <div class="col-md-6 {{ isset($data->video_type) && $data->video_type == 'self_hosted' ? '' : 'd-none' }}"
                                        ...
                                        <label for="" class="form-label">
                                            Video<span class="text-asterisks text-sm">*</span>
                                        </label>
                                        <div class="form-group">
                                                ...
                                                <div
                                                    ...
                                                    <div class='image-upload-div'>
                                                        <img class="img-fluid mb-2"
                                                            ...
                                                            alt="{{ labels('admin_labels.product_video_alt', 'Product Video') }}" title="{{ labels('admin_labels.product_video_alt', 'Product Video') }}">
                                                    </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control mt-2 d-none mb-2 custom_description_prompt" name="custom_description_prompt"
                                    placeholder="{{ labels('admin_labels.placeholder_custom_ai_prompt', 'Enter your own AI prompt (optional)...') }}"></textarea>
                                <textarea name="pro_input_description" id="pro_input_description" class="form-control addr_editor"
                                    placeholder="{{ labels('admin_labels.place_some_text_here', 'Place some text here') }}">{{ isset($data->description) ? $data->description : '' }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea id="extra_input_description" name="extra_input_description"
                                    class="form-control addr_editor extra_input_description" placeholder="{{ labels('admin_labels.place_some_text_here', 'Place some text here') }}">{{ isset($data->extra_description) ? $data->extra_description : '' }}</textarea>
