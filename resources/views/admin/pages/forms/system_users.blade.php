                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body row">
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        <label for="email" class="control-label">{{ labels('admin_labels.email', 'Email') }}
                                            <span class="text-asterisks text-sm">*</span></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="role" class="control-label">{{ labels('admin_labels.role', 'Role') }}
                                            <span class="text-asterisks text-sm">*</span></label>
                                        <div class="col-md-12">
                                            <select class="form-control system-user-role form-select" name="role">
                                                <option value=" ">{{ labels('admin_labels.select_role', '---Select role---') }}</option>
                                                <option value="1">{{ labels('admin_labels.super_admin', 'Super Admin') }}</option>
                                                <option value="5">{{ labels('admin_labels.admin', 'Admin') }}</option>
                                                <option value="6">{{ labels('admin_labels.editor', 'Editor') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-0">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th>{{ labels('admin_labels.permissions_modules', 'Permissions/Modules') }}</th>
                                                            <th>{{ labels('admin_labels.view_permission', 'View') }}</th>
                                                            <th>{{ labels('admin_labels.create_permission', 'Create') }}</th>
                                                            <th>{{ labels('admin_labels.title_edit', 'Edit') }}</th>
                                                            <th>{{ labels('admin_labels.title_delete', 'Delete') }}</th>
                                                        </tr>
                                                    </thead>
