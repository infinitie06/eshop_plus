                                ...
                                <div class="m-2">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <label class="form-label" for="basic-default-fullname">
                                                    {{ labels('admin_labels.smtp_host', 'SMTP Host') }}
                                                    <span class='text-asterisks text-sm'>*</span>
                                                </label>
                                                <input type="text" class="form-control" id="basic-default-fullname"
                                                    placeholder="{{ labels('admin_labels.support_email_placeholder', 'eshop@gmail.com') }}" name="smtp_host"
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <label class="form-label" for="basic-default-fullname">
                                                    {{ labels('admin_labels.smtp_port', 'SMTP Port') }}
                                                    <span class='text-asterisks text-sm'>*</span>
                                                </label>
                                                <input type="text" class="form-control" id="basic-default-fullname"
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <label class="form-label" for="basic-default-fullname">
                                                    {{ labels('admin_labels.email_content_type', 'Email Content Type') }}
                                                    <span class='text-asterisks text-sm'>*</span>
                                                </label>
                                                <select class="form-select form-select-md mb-3"
                                                    ...
                                                    <option
                                                        ...
                                                        value="html">{{ labels('admin_labels.html_format', 'HTML') }}
                                                    </option>
                                                    <option
                                                        {{ $settings['email_content_type'] != null && $settings['email_content_type'] == 'text' ? 'selected' : '' }}
                                                        value="text">{{ labels('admin_labels.text_format', 'TEXT') }}
                                                    </option>
                                                </select>
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <label class="form-label" for="basic-default-fullname">
                                                    {{ labels('admin_labels.smtp_encryption', 'SMTP Encryption') }}
                                                    <span class='text-asterisks text-sm'>*</span>
                                                </label>
                                                <select class="form-select form-select-md mb-3"
                                                    ...
                                                    <option
                                                        ...
                                                        value="ssl">{{ labels('admin_labels.ssl_encryption', 'SSL') }}
                                                    </option>
                                                    <option
                                                        {{ $settings['smtp_encryption'] != null && $settings['smtp_encryption'] == 'off' ? 'selected' : '' }}
                                                        value="off">{{ labels('admin_labels.off_value', 'Off') }}
                                                    </option>
                                                    <option
                                                        {{ $settings['smtp_encryption'] != null && $settings['smtp_encryption'] == 'tls' ? 'selected' : '' }}
                                                        value="tls">{{ labels('admin_labels.tls_encryption', 'TLS') }}
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
