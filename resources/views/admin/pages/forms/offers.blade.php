                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" id="offer_type" class="form-select form-control type_event_trigger"
                                    ...
                                    <option value="categories">{{ labels('admin_labels.category_option', 'Category') }}</option>
                                    <option value="all_products">{{ labels('admin_labels.all_products_option', 'All Products') }}</option>
                                    <option value="all_combo_products">{{ labels('admin_labels.combo_products_option', 'Combo Products') }}</option>
                                    <option value="products">{{ labels('admin_labels.specific_product_option', 'Specific Product') }}</option>
                                    <option value="combo_products">{{ labels('admin_labels.specific_combo_product', 'Specific Combo Product') }}</option>
                                    <option value="brand">{{ labels('admin_labels.brand_option', 'Brand') }}</option>
                                    <option value="offer_url">{{ labels('admin_labels.offer_url', 'Offer URL') }}</option>
                                </select>
                            </div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_offer_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button></li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_offer_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button></li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_offer_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button></li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_offer_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
