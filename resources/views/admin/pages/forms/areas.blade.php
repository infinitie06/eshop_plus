        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-info">
                    ...
                    <div class="card-header">
                        <h5 class="mb-0">{{ labels('admin_labels.add_area', 'Add Area') }}</h5>
                    </div>
                    <form class="form-horizontal form-submit-event submit_form" action="{{ route('admin.area.store') }}"
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select zipcode_list" name="zipcode" id="">
                                            <option value=" ">{{ labels('admin_labels.select_pincode', 'Select Pincode') }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary">{{ labels('admin_labels.add_area', 'Add Area') }}</button>
                            </div>
            ...
            <div class="col-md-12 main-content mt-4">
                <div class="card content-area p-4">
                    <div class="card-head">
                        <h4 class="card-title">{{ labels('admin_labels.area_details', 'Area Details') }}</h4>
                    </div>
                    <div class="card-innr">
                        ...
                        <table class='table table-striped' data-toggle="table" data-loading-template="loadingTemplate" data-url="{{ route('admin.area.list') }}"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="zipcode" data-sortable="false">{{ labels('admin_labels.zipcode_th', 'Zipcode') }}</th>
                                    <th data-field="minimum_free_delivery_order_amount" data-sortable="false">
                                        Minimum Free Delivery Order Amount</th>
                                    <th data-field="delivery_charges" data-sortable="false">{{ labels('admin_labels.delivery_charges_label', 'Delivery Charges') }}</th>
