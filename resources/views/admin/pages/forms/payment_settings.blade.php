                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <select name="paypal_method"
                                        ...
                                        <option value="1"
                                            ...
                                            {{ labels('admin_labels.active_users', 'Active') }}
                                        </option>
                                        <option value="0"
                                            ...
                                            <div class="form-group col-md-12 mt-2">
                                                <select name="paypal_mode" class="form-control form-select">
                                                    ...
                                                    <option value="sandbox"
                                                        ...
                                                        {{ labels('admin_labels.sandbox_testing', 'Sandbox (Testing)') }}
                                                    </option>
                                                    <option value="production"
                                                        <?= isset($settings['paypal_mode']) && $settings['paypal_mode'] == 'production' ? 'selected' : '' ?>>
                                                        {{ labels('admin_labels.production_live', 'Production (Live)') }}
                                                    </option>
                                                </select>
                                        ...
                                        <div class="form-group col-md-12">
                                            <select name="phonepe_mode" class="form-control form-select">
                                                ...
                                                <option value="production"
                                                    ...
                                                    {{ labels('admin_labels.uta_label', 'UTA') }}</option>
                                                <option value="production"
                                                    <?= isset($settings['phonepe_mode']) && $settings['phonepe_mode'] != null && $settings['phonepe_mode'] == 'production' ? 'selected' : '' ?>>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6 d-none">
                                        ...
                                        <input type="text" class="form-control width" name="phonepe_salt_index"
                                            placeholder="{{ labels('admin_labels.salt_index_label', 'Salt Index') }}"
                                    ...
                                    <div class="col-md-6 d-none">
                                        ...
                                        <input type="text" class="form-control width" name="phonepe_salt_key"
                                            placeholder="{{ labels('admin_labels.salt_key_label', 'Salt Key') }}" value="{{ $settings['phonepe_salt_key'] ?? '' }}" />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label"
                                        ...
                                        <input type="text" class="form-control width" name="phonepe_client_id"
                                            placeholder="{{ labels('admin_labels.client_id_short', 'Client ID') }}" value="{{ $settings['phonepe_client_id'] ?? '' }}" />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label"
                                        ...
                                        <input type="text" class="form-control width" name="phonepe_client_secret"
                                            placeholder="{{ labels('admin_labels.client_secret_short', 'Client Secret') }}"
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control width" name="phonepe_merchant_id"
                                            placeholder="{{ labels('admin_labels.merchant_id_short', 'Merchant ID') }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="stripe_payment_mode" class="form-select">
                                            ...
                                            <option value="test"
                                                ...
                                                {{ labels('admin_labels.test_option', 'Test') }}</option>
                                            <option value="live"
                                                <?= isset($settings['stripe_payment_mode']) && $settings['stripe_payment_mode'] == 'live' ? 'selected' : '' ?>>
                                                {{ labels('admin_labels.live_option', 'Live') }}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label"
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="stripe_currency_code" class="form-control form-select mt-2">
                                            <option value="">{{ labels('admin_labels.select_currency_code', 'Select Currency Code') }}</option>
                                            @php
                                                $currencyOptions = [
                                                    'INR' => 'Indian rupee',
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-6">
                                            ...
                                            <select name="myfatoorah_language" class="form-control form-select">
                                                <option value="">{{ labels('admin_labels.select_language_option', 'Select Language') }}</option>
                                                <option value="english"
                                                    <?= isset($settings['myfatoorah_language']) && $settings['myfatoorah_language'] == 'english' ? 'selected' : '' ?>>
                                                    {{ labels('admin_labels.english_placeholder', 'English') }}</option>
                                                <option value="arabic"
                                                    <?= isset($settings['myfatoorah_language']) && $settings['myfatoorah_language'] == 'arabic' ? 'selected' : '' ?>>
                                                    {{ labels('admin_labels.arabic_lang', 'Arabic') }}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="midtrans_payment_mode" class="form-select">
                                                ...
                                                <option value="sandbox"
                                                    ...
                                                    {{ labels('admin_labels.sandbox_option', 'Sandbox') }}</option>
                                                <option value="production"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="account_name"
                                            ...
                                            placeholder="{{ labels('admin_labels.account_name_placeholder', 'Account Name') }}" />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label"
                                        ...
                                        <input type="number" step="any" class="form-control" name="account_number"
                                            ...
                                            placeholder="{{ labels('admin_labels.account_number_placeholder', 'Account Number') }}" />
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="bank_name"
                                            ...
                                            placeholder="{{ labels('admin_labels.bank_name_placeholder', 'Bank Name') }}" />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label"
                                        ...
                                        <input type="text" class="form-control" name="bank_code"
                                            ...
                                            placeholder="{{ labels('admin_labels.bank_code_placeholder', 'Bank Code') }}" />
                                    </div>
                                </div>
