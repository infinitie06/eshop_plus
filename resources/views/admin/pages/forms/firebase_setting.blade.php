        ...
        <div class="card-body">
            <form id="general_setting_form" action="{{ route('firebase_settings.store') }}" class="submit_form"
                ...
                <div class="row">
                    ...
                    <hr>
                    <p class="text-danger">"{{ labels('admin_labels.google_facebook_credentials_note', 'If you have web application than field below Google and Facebook Credentials') }}"
                    </p>
                    <div class="form-group col-md-6">
                        <label class="form-label mb-3 mt-3"
                        ...
                        <input type="text" class="form-control" name="google_client_id"
                            ...
                            placeholder="{{ labels('admin_labels.placeholder_google_client_id_value', 'google client id') }}" />
                    </div>
                    <div class="form-group col-md-6">
                        <label class="form-label mb-3 mt-3"
                        ...
                        <input type="text" class="form-control" name="google_client_secret"
                            ...
                            placeholder="{{ labels('admin_labels.placeholder_google_client_secret_value', 'google client secret') }}" />
                    </div>
                    <div class="form-group col-md-6">
                        <label class="form-label mb-3 mt-3"
                        ...
                        <input type="text" class="form-control" name="google_redirect_url"
                            ...
                            placeholder="{{ labels('admin_labels.placeholder_google_redirect_url', 'Google Redirect url') }}" />
                    </div>
                    <div class="form-group col-md-6">
                        <label class="form-label mb-3 mt-3"
                        ...
                        <input type="text" class="form-control" name="facebook_client_id"
                            ...
                            placeholder="{{ labels('admin_labels.placeholder_facebook_client_id_value', 'Facebook Client id') }}" />
                    </div>
                    <div class="form-group col-md-6">
                        <label class="form-label mb-3 mt-3"
                        ...
                        <input type="text" class="form-control" name="facebook_client_secret"
                            ...
                            placeholder="{{ labels('admin_labels.placeholder_facebook_client_secret_value', 'Facebook Client Secret') }}" />
                    </div>
                    <div class="form-group col-md-6">
                        <label class="form-label mb-3 mt-3"
                        ...
                        <input type="text" class="form-control" name="facebook_redirect_url"
                            ...
                            placeholder="{{ labels('admin_labels.placeholder_facebook_redirect_url', 'Facebook Redirect url') }}" />
                    </div>
                </div>
