                            ...
                            <div class="form-group">
                                <label for="send_to"
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       ...
                                       data-bs-content="{{ labels('admin_labels.send_notification_all_or_specific_users', 'Choose whether to send notification to all users or specific users.') }}"></i>
                                </label>
                                <select name="send_to" id="send_to" class="form-control form-select type_event_trigger"
                                    required>
                                    <option value="all_users">{{ labels('admin_labels.all_users_option', 'All Users') }}</option>
                                    <option value="specific_user">{{ labels('admin_labels.specific_user_option', 'Specific User') }}</option>
                                </select>
                            </div>
                            <div class="form-group row notification-users d-none">
                                <label for="user_id"
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.select_users_for_notification', 'Select users to receive the notification.') }}"></i>
                                </label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label for="type"
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.select_notification_type_help', 'Select the type of notification (Default, Category, Product, URL).') }}"></i>
                                </label>
                                <select name="type" id="type" class="form-control form-select type_event_trigger"
                                    ...
                                    <option value="products">{{ labels('admin_labels.product_option', 'Product') }}</option>
                                ...
                                <div class="form-group notification-categories d-none">
                                    <label for="category_id">{{ labels('admin_labels.categories', 'Categories') }}
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                                           data-bs-content="{{ labels('admin_labels.select_category_for_notification_help', 'Select a category for the notification.') }}"></i>
                                    </label>
                                ...
                                <div class="form-group row notification-products d-none">
                                    <label for="product_id"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                                           data-bs-content="{{ labels('admin_labels.select_product_for_notification_help', 'Select a product for the notification.') }}"></i>
                                    </label>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_notification_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_notification_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_notification_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_notification_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
