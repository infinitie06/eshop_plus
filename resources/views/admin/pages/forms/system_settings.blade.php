                        ...
                        <div class="row">
                            ...
                            <div class="nav flex-column  p-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                <a class="nav-link active border payment_method_title" data-bs-toggle="pill"
                                    ...
                                    aria-selected="true">{{ labels('admin_labels.app_settings', 'App & System Settings') }}</a>
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade active show" id="app_setting" role="tabpanel">
                            <div class="card">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="mb-3 col-md-4">
                                            <label class="form-label" for="basic-default-fullname">
                                                {{ labels('admin_labels.app_name', 'App Name') }}<span
                                        ...
                                        <div class="mb-3 col-md-4">
                                            <label class="form-label" for="support_number">
                                                {{ labels('admin_labels.support_number', 'Support Number') }}<span
                                                    class='text-asterisks text-sm'>*</span>
                                            </label>
                                            <input type="number" maxlength="16" oninput="validateNumberInput(this)"
                                                class="form-control" id="support_number" name="support_number"
                                                value="<?= isKeySetAndNotEmpty($settings, 'support_number') ? $settings['support_number'] : '' ?>">
                                        </div>

                                        <div class="mb-3 col-md-4">
                                            <label class="form-label" for="support_email">
                                                {{ labels('admin_labels.support_email', 'Support Email') }}<span
                                                    class='text-asterisks text-sm'>*</span>
                                            </label>
                                            <input type="email" class="form-control" id="support_email"
                                                placeholder="{{ labels('admin_labels.support_email_placeholder', 'eshop@gmail.com') }}" name="support_email"
                                                value="<?= isKeySetAndNotEmpty($settings, 'support_email') ? $settings['support_email'] : '' ?>">
                                        </div>

                                        <div class="mb-3 col-md-4">
                                            <label class="form-label" for="android_customer">
                                                {{ labels('admin_labels.current_version_of_android_app', 'Current Version Of Android APP') }}
                                                ({{ labels('admin_labels.customer_app_label', 'Customer app') }})<span class='text-asterisks text-sm'>*</span>
                                            </label>
                                            <input type="text" class="form-control" id="android_customer"
                                                name="current_version_of_android_app"
                                                value="<?= isKeySetAndNotEmpty($settings, 'current_version_of_android_app') ? $settings['current_version_of_android_app'] : '' ?>">
                                        </div>

                                        <div class="mb-3 col-md-4">
                                            <label class="form-label" for="ios_customer">
                                                {{ labels('admin_labels.current_version_of_ios_app', 'Current Version Of IOS APP') }}
                                                ({{ labels('admin_labels.customer_app_label', 'Customer app') }})<span class='text-asterisks text-sm'>*</span>
                                            </label>
                                            <input type="text" class="form-control" id="ios_customer"
                                                name="current_version_of_ios_app"
                                                value="<?= isKeySetAndNotEmpty($settings, 'current_version_of_ios_app') ? $settings['current_version_of_ios_app'] : '' ?>">
                                        </div>

                                        <div class="mb-3 col-md-4">
                                            <label class="form-label" for="android_seller">
                                                {{ labels('admin_labels.current_version_of_android_app', 'Current Version Of Android APP') }}
                                                ({{ labels('admin_labels.seller_app_label', 'Seller app') }})<span class='text-asterisks text-sm'>*</span>
                                            </label>
                                            <input type="text" class="form-control" id="android_seller"
                                                name="current_version_of_android_app_for_seller"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            <label class="form-label" for="ios_seller">
                                                {{ labels('admin_labels.current_version_of_ios_app', 'Current Version Of IOS APP') }}
                                                ({{ labels('admin_labels.seller_app_label', 'Seller app') }})<span class='text-asterisks text-sm'>*</span>
                                            </label>
                                            <input type="text" class="form-control" id="ios_seller"
                                                name="current_version_of_ios_app_for_seller"
                                                value="<?= isKeySetAndNotEmpty($settings, 'current_version_of_ios_app_for_seller') ? $settings['current_version_of_ios_app_for_seller'] : '' ?>">
                                        </div>

                                        <div class="mb-3 col-md-4">
                                            <label class="form-label" for="android_delivery">
                                                {{ labels('admin_labels.current_version_of_android_app', 'Current Version Of Android APP') }}
                                                ({{ labels('admin_labels.delivery_boy_app_label', 'Delivery Boy app') }})<span class='text-asterisks text-sm'>*</span>
                                            </label>
                                            <input type="text" class="form-control" id="android_delivery"
                                                name="current_version_of_android_app_for_delivery_boy"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            <label class="form-label" for="ios_delivery">
                                                {{ labels('admin_labels.current_version_of_ios_app', 'Current Version Of IOS APP') }}
                                                ({{ labels('admin_labels.delivery_boy_app_label', 'Delivery Boy app') }})<span class='text-asterisks text-sm'>*</span>
                                            </label>
                                            <input type="text" class="form-control" id="ios_delivery"
                                                name="current_version_of_ios_app_for_delivery_boy"
                                        ...
                                        <div class="mb-2 col-md-4">
                                            <label class="form-label" for="version_system_status">
                                                {{ labels('admin_labels.version_system_status', 'Version System Status') }}<span
                                                    class='text-asterisks text-sm'>*</span>
                                                <i class="fas fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="{{ labels('admin_labels.popover_version_system_status', 'Enable or disable the version checking system. If enabled, users will be forced to update when a new version is released.') }}"></i>
                                            </label>
                                            <div class="form-check form-switch mx-5">
                                                <input class="form-check-input" type="checkbox"
                                                    id="version_system_status" name="version_system_status"
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-12">
                                                    <label class="form-label d-flex align-items-center" for="facebook">
                                                        ...
                                                        <span class="">{{ labels('admin_labels.only_for_web', '(Only For Web)') }}</span>
                                                    </label>
                                                </div>
                                    ...
                                    <h6 class="mb-4 mt-4">
                                        {{ labels('admin_labels.deep_linking', 'Deep Linking') }}
                                    </h6>
                                    <div class="row">
                                        <div class="mb-3 col-md-4">
                                            <label class="form-label" for="deep_link_scheme">
                                                {{ labels('admin_labels.deep_link_scheme', 'Deep Link Scheme') }}
                                                <span class='text-asterisks text-sm'>*</span>
                                            </label>
                                            <input type="text" class="form-control" id="deep_link_scheme"
                                                placeholder="{{ labels('admin_labels.deep_link_scheme_placeholder', 'eshop') }}" name="deep_link_scheme"
                                                value="<?= isKeySetAndNotEmpty($settings, 'deep_link_scheme') ? str_replace('://', '', $settings['deep_link_scheme']) : 'eshop' ?>">
                                            <small class="form-text text-muted">
                                                {{ labels('admin_labels.deep_link_scheme_hint', 'Enter only the scheme name (e.g., eshop).') }}
                                            </small>
                                        </div>
                                        <div class="mb-3 col-md-4">
                                            <label class="form-label" for="deep_link_host">
                                                {{ labels('admin_labels.deep_link_host', 'Deep Link Host') }}
                                                <span class='text-asterisks text-sm'>*</span>
                                            </label>
                                            <input type="text" class="form-control" id="deep_link_host"
                                                placeholder="{{ labels('admin_labels.deep_link_host_placeholder', 'eshop-pro.eshopweb.store') }}" name="deep_link_host"
                                                value="<?= isKeySetAndNotEmpty($settings, 'deep_link_host') ? $settings['deep_link_host'] : 'eshop-pro.eshopweb.store' ?>">
                                            <small class="form-text text-muted">
                                                {{ labels('admin_labels.deep_link_host_hint', 'Enter the host domain (e.g., eshop-pro.eshopweb.store).') }}
                                            </small>
                                        </div>
                                        <div class="mb-3 col-md-4">
                                            <label class="form-label" for="android_package_name">
                                                {{ labels('admin_labels.android_package_name', 'Android Package Name') }}
                                                <span class='text-asterisks text-sm'>*</span>
                                            </label>
                                            <input type="text" class="form-control" id="android_package_name"
                                                placeholder="{{ labels('admin_labels.android_package_name_placeholder', 'com.eshop.pro') }}" name="android_package_name"
                                                value="<?= isKeySetAndNotEmpty($settings, 'android_package_name') ? $settings['android_package_name'] : '' ?>">
                                            <small class="form-text text-muted">
                                                {{ labels('admin_labels.android_package_name_hint', "Enter your Android app's package name.") }}
                                            </small>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="file_upload_box border file_upload_border mt-4">
                                                        <div class="mt-2 text-center">
                                                            <a class="media_link" data-input="logo" data-isremovable="0"
                                                                ...
                                                                <h4><i class='bx bx-upload'></i> {{ labels('admin_labels.upload_option', 'Upload') }}</h4>
                                                            </a>
                                                            <p class="image_recommendation">{{ labels('admin_labels.recommended_size_120_150_pixels', 'Recommended Size : larger than 120 x 120 & smaller than 150 x 150 pixels.') }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class=''>
                                                                    <div class='upload-media-div'><img
                                                                            ...
                                                                            alt="{{ labels('admin_labels.not_found_alt', 'Not Found') }}"></div>
                                                    ...
                                                    <div class="col-md-12 file_upload_box border file_upload_border">
                                                        <div class="mt-2">
                                                            <div class="col-md-12  text-center">
                                                                <div>
                                                                    <p class="caption text-dark-secondary">{{ labels('admin_labels.choose_images_for_onboarding', 'Choose images for onboarding.') }}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        @foreach ($settings['on_boarding_image'] as $row)
                                                            <div
                                                                ...
                                                                <div class='image-upload-div'>
                                                                    <img class="img-fluid mb-2" alt="{{ labels('admin_labels.not_found_alt', 'Not Found') }}"
                                                                ...
                                                                <a href="javascript:void(0)" class="delete-onboard-media"
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        {{ labels('admin_labels.title_delete', 'Delete') }}</span></a>
                                            ...
                                            <a class="media_link" data-input="on_boarding_video[]"
                                                ...
                                                <div class="col-md-12 file_upload_box border file_upload_border">
                                                    <div class="mt-2">
                                                        <div class="col-md-12  text-center">
                                                            <div>
                                                                <p class="caption text-dark-secondary">{{ labels('admin_labels.choose_videos_for_onboarding', 'Choose videos for onboarding.') }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    @foreach ($settings['on_boarding_video'] as $row)
                                                        <div
                                                            ...
                                                            <a href="javascript:void(0)" class="delete-onboard-media"
                                                                ...
                                                                <span
                                                                    class="btn btn-block bg-gradient-danger text-danger btn-xs"><i
                                                                        class="far fa-trash-alt "></i> {{ labels('admin_labels.title_delete', 'Delete') }}</span></a>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label" for="basic-default-fullname">
                                                {{ labels('admin_labels.minimum_cart_amount', 'Minimum Cart Amount') }}
                                                <span class='text-asterisks text-sm'>*</span>
                                            </label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label"
                                                for="basic-default-fullname">{{ labels('admin_labels.country_code', 'Country Code') }}<span
                                                    class='text-asterisks text-sm'>*</span></label>
                                            <input type="number" class="form-control" id="basic-default-fullname" min=1
                                                placeholder="" name="country_code"
                                                value="<?= isKeySetAndNotEmpty($settings, 'country_code') ? $settings['country_code'] : '' ?>">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label"
                                                for="google_map_key">{{ labels('admin_labels.google_map_key', 'Google Map Key') }}</label>
                                            <input type="text" class="form-control" id="google_map_key"
                                                placeholder="{{ labels('admin_labels.google_map_api_key_placeholder', 'Enter Google Map API Key') }}" name="google_map_key"
                                                value="<?= isKeySetAndNotEmpty($settings, 'google_map_key') ? $settings['google_map_key'] : '' ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label"
                                                for="basic-default-fullname">{{ labels('admin_labels.delivery_boy_bonus', 'Delivery Boy Bonus') }}</label>
                                            <input type="number" min=1 class="form-control" id="basic-default-fullname"
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <select class="form-select form-select-md mb-3"
                                                ...
                                                <option
                                                    ...
                                                    value="percentage">
                                                    {{ labels('admin_labels.percentage_option', 'Percentage') }}
                                                </option>
                                                <option
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="firebase_radio_button">
                                                    {{ labels('admin_labels.firebase_authentication', 'Firebase Authentication') }}
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="sms_radio_button">
                                                    {{ labels('admin_labels.custom_sms_gateway_otp_based', 'Custom SMS Gateway OTP based') }}
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <div class="firebase_config d-none">
                                                <a href="{{ route('firebase') }}">
                                                    <p class="text-danger">{{ labels('admin_labels.please_config_firebase_here', 'Please config firebase config here *') }}</p>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mt-2">
                                            <div class="sms_gateway d-none">
                                                <a href="{{ route('sms_gateway') }}">
                                                    <p class="text-danger"> {{ labels('admin_labels.please_config_sms_gateway_here', 'Please config SMS gateway config here *') }} </p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-6">
                                                    <a class="btn btn-xs mx-2 btn-primary text-white mb-2"
                                                        ...
                                                        title="{{ labels('admin_labels.how_it_works_title', 'How it works') }}">{{ labels('admin_labels.how_it_works', 'How It Works') }}?</a>
                                                </div>
                                            </div>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="howItWorksModalLabel1">{{ labels('admin_labels.how_promo_code_discount_credited', 'How Promo Code Discount will get credited?') }}</h4>
                        ...
                        <div class="modal fade" id="howItWorksModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="howItWorksModalLabel">{{ labels('admin_labels.how_seller_commission_credited', 'How seller commission will get credited?') }}</h4>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
