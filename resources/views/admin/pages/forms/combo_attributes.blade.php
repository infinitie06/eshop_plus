                    ...
                    <form class="submit_form" action="{{ route('admin.combo_product_attributes.store') }}" method="POST"
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="basic-default-fullname" placeholder="{{ labels('admin_labels.size_placeholder', 'Size') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="attribute_values" placeholder="{{ labels('admin_labels.small_medium_placeholder', 'Small,Medium') }}"
                                    name="value">
