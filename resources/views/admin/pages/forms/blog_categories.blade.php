                            ...
                            <div class="form-group">
                                <form id="" action="{{ route('blog_category.store') }}" class="submit_form"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="tab-pane fade show active" id="content-en" role="tabpanel"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="name" class="form-control"
                                                        placeholder="{{ labels('admin_labels.name_placeholder', 'Name') }}" value="">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <label for=""
                                                class="form-label">{{ labels('admin_labels.image', 'Image') }}
                                                ({{ labels('admin_labels.optional', 'Optional') }})</label>
                                            <div class="col-md-12">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_blog_category_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_blog_category_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_blog_category_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_blog_category_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
