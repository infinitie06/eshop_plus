...
<div class="row">
    ...
    <div class="col-md-12 col-lg-6">
        <div class="card">
            <form class="form-horizontal" action="{{ route('brands.bulk_upload') }}" method="POST" enctype="multipart/form-data" id="bulk_upload_form">
                @csrf
                <div class="card-body">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6 mb-2">
                            <a href="{{ asset('storage/brand-bulk-upload.zip') }}" download="brand-bulk-upload.zip"
                        ...
                        <div class="col-md-6 mb-2">
                            <a href="{{ asset('storage/bulk_upload_brands.pdf') }}" download="bulk_upload_brands.pdf"
                               class="btn btn-outline-primary btn-sm w-100">
        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                <ul class="list-unstyled ms-2">
                    ...
                    <li class="mb-1">Images must have valid paths available in the Media section</li>
