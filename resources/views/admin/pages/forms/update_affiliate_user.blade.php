                                ...
                                <div class="step-page" id="page1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" value="{{ old('full_name', $user->username) }}"
                                                ...
                                                placeholder="{{ labels('admin_labels.enter_full_name', 'Enter Full Name') }}">
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" value="{{ old('email', $user->email) }}"
                                                ...
                                                placeholder="{{ labels('admin_labels.enter_email', 'Enter Email') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <script>
                                                (function () {
                                                    var savedCode = @json(old('country_code', $user->country_code ?? ''));
                                                    if (savedCode) {
                                            ...
                                            <input type="text" class="form-control" id="mobile" name="mobile"
                                                maxlength="16" placeholder="{{ labels('admin_labels.enter_mobile', 'Enter Mobile') }}"
                                                value="{{ old('mobile', $user->mobile) }}"
                                                oninput="validateNumberInput(this)"></div>
                                        </div>
                                        {{-- Address --}}
                                        <div class="col-md-6 mb-3">
                                            <label for="address" class="form-label">{{ labels('admin_labels.address', 'Address') }} <span
                                                    class="text-danger">*</span></label>
                                            <textarea class="form-control" id="address" name="address" rows="3" placeholder="{{ labels('admin_labels.enter_address', 'Enter Address') }}">{{ old('address', $user->address) }}</textarea>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="url" class="form-control" id="website_url"
                                                ...
                                                name="website_url" placeholder="{{ labels('admin_labels.website_url_example', 'https://www.example.com/myblog') }}">
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="url" class="form-control" id="application_url"
                                                ...
                                                name="application_url" placeholder="{{ labels('admin_labels.application_url_example', 'https://xxxx/dp/xxxx') }}">
                                        </div>
                                    </div>

                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="btn btn-secondary"
                                            onclick="prevStep(1)">{{ labels('admin_labels.previous_step', 'Previous') }}</button>
                                        <button type="button" class="btn btn-primary"
                                            onclick="nextStep(3)">{{ labels('admin_labels.next_step', 'Next') }}</button>
                                    </div>
                                </div>
