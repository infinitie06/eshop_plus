                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 mt-2">
                                                <input type="text" name="zipcode_delivery_charge" class="form-control"
                                                    placeholder="{{ labels('admin_labels.delivery_charge_placeholder', 'Delivery Charge') }}"
                                                    value="{{ $zipcode->delivery_charges }}" />
                                            </div>
                                            <div class="col-md-2">
                                                <input data-repeater-delete type="button" class="btn btn-secondary mt-2"
                                                    value="{{ labels('admin_labels.title_delete', 'Delete') }}" />
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            <input data-repeater-create type="button" class="btn btn-primary mt-2" value="{{ labels('admin_labels.add_option', 'Add') }}" />
                        </div>
                                        ...
                                        <div class="row city_list_parent">
                                            ...
                                            <div class="col-md-5 mt-2">
                                                <input type="text" name="city_delivery_charge" class="form-control"
                                                    placeholder="{{ labels('admin_labels.delivery_charge_placeholder', 'Delivery Charge') }}" value="{{ $city->delivery_charges }}" />
                                            </div>
                                            <div class="col-md-2">
                                                <input data-repeater-delete type="button" class="btn btn-secondary mt-2"
                                                    value="{{ labels('admin_labels.title_delete', 'Delete') }}" />
