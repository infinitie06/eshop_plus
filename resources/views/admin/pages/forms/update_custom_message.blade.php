            ...
            <form class="form-horizontal submit_form" action="{{ url('/admin/custom_message/update/' . $data->id) }}"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="title" id="custom_message_title"
                                class="form-control custom_message_title" placeholder="{{ labels('admin_labels.title_placeholder', 'Title') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <textarea name="message" id="text-box" class="form-control" placeholder="{{ labels('admin_labels.place_some_text_here', 'Place some text here') }}">{{ isset($data->message) ? $data->message : '' }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row place_order d-none">
