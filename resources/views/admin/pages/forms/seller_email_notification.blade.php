                            ...
                            <div class="form-group">
                                <label for=""
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       ...
                                       data-bs-content="{{ labels('admin_labels.send_email_all_or_specific_sellers', 'Choose whether to send email to all sellers or specific sellers.') }}"></i>
                                </label>
                            ...
                            <div class="form-group row notification-sellers d-none">
                                <label for="user_id"
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.select_sellers_for_email_notification', 'Select sellers to receive the email notification.') }}"></i>
                                </label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label for="title"
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.enter_email_subject_help', 'Enter the subject of the email notification.') }}"></i>
                                </label>
                            ...
                            <div class="form-group">
                                <label for="message"
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="{{ labels('admin_labels.enter_email_message_help', 'Enter the message content for the email notification.') }}"></i>
                                </label>
                                <textarea class="form-control addr_editor" placeholder="{{ labels('admin_labels.placeholder_message', 'Message') }}" name="message"></textarea>
                            </div>
