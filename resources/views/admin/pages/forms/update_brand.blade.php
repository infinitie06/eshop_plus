                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="file_upload_box border file_upload_border mt-4">
                                                    <div class="mt-2 text-center">
                                                        ...
                                                        <p class="image_recommendation">{{ labels('admin_labels.recommended_size_180x180_pixels', 'Recommended Size: 180 x 180 pixels') }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            @if ($data->image && !empty($data->image))
                                                <div class="col-md-6">
                                                    <label for="" class="text-danger">*{{ labels('admin_labels.only_choose_when_update_necessary', 'Only Choose When Update is necessary') }}</label>
