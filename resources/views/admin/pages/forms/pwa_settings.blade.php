            ...
            <form id="general_setting_form" action="{{ route('pwa_settings.store') }}" class="submit_form"
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="form-group d-flex col-md-12 align-items-center justify-content-between">
                            <label for="">{{ labels('admin_labels.theme_color', 'Theme Color') }}
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="form-group d-flex col-md-12 align-items-center justify-content-between">
                            <label for="">{{ labels('admin_labels.background_color', 'Background Color') }}
                                <span class="text-asterisks text-sm">*</span>
                            </label>
                            <div class="col-md-4 d-flex justify-content-end">
                ...
                <div class="row">
                    <div class="mb-3 col-md-12">
                        ...
                        <textarea name="description" class="form-control" placeholder="{{ labels('admin_labels.write_here_your_description', 'Write here your description') }}">{{ old('description') }}{{ !empty($pwa_settings['description']) ? $pwa_settings['description'] : '' }}</textarea>
                    </div>
                </div>
                <div class="col-md-12 form-group">
                    <label for="image">{{ labels('admin_labels.logo', 'Logo') }}
                        <span class='text-asterisks text-sm'>*</span>
                        <small class="text-danger fs-6"> ({{ labels('admin_labels.please_upload_minimum_512_logo', 'Please upload minimum 512 x 512 logo or else it will not work.') }})</small>
                    </label>
                    <div>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="file_upload_box border file_upload_border mt-4">
                                    <div class="mt-2 text-center">
                                        ...
                                        <p class="image_recommendation">{{ labels('admin_labels.recommended_size_larger_than_512', 'Recommended Size : larger than 512 x 512') }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if (!empty($pwa_settings['logo']))
                                    <label for="" class="text-danger mt-3">*{{ labels('admin_labels.only_choose_when_update_is_necessary', 'Only Choose When Update is necessary') }}</label>
