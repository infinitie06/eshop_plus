                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="col-md-8 d-flex justify-content-end">
                                    <a class="toggle form-switch me-1 mb-1" title="{{ labels('admin_labels.title_deactivate', 'Deactivate') }}" href="javascript:void(0)">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="title"
                                    ...
                                    placeholder="{{ labels('admin_labels.morning_time_slot_placeholder', 'Morning 9AM to 12PM') }}">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" name="from_time"
                                    ...
                                    placeholder="{{ labels('admin_labels.from_time_placeholder', '09:00:00') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" name="to_time"
                                    ...
                                    placeholder="{{ labels('admin_labels.to_time_placeholder', '12:00:00') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" name="last_order_time"
                                    ...
                                    placeholder="{{ labels('admin_labels.last_order_time_placeholder', '11:00:00') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" class="form-control form-select">
                                    ...
                                    <option value="1"
                                        ...
                                        {{ labels('admin_labels.active_users', 'Active') }}</option>
                                    <option value="0"
                                        <?= isset($fetched_data[0]['status']) && $fetched_data[0]['status'] == 0 ? 'selected' : '' ?>>
                                        {{ labels('admin_labels.deactive_users', 'Deactive') }}</option>
                                </select>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_time_slot_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button></li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_time_slot_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button>
                                        </li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_time_slot_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button></li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_time_slot_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
