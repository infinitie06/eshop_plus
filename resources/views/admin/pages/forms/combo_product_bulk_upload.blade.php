...
<div class="row">
    ...
    <div class="col-md-12 col-lg-6">
        <div class="card">
            <form class="form-horizontal" action="{{ route('admin.combo.product.process_bulk_upload') }}" method="POST" enctype="multipart/form-data" id="bulk_upload_form">
                @csrf
                <div class="card-body">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6 mb-2">
                            <a href="{{ asset('storage/combo-product-bulk-upload.zip') }}" download="combo-product-bulk-upload.zip"
