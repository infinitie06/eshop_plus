                    ...
                    <form class="form-horizontal submit_form" action="{{ route('custom_message.store') }}" method="POST"
                        ...
                        <div class=" card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="title" id="custom_message_title"
                                        class="form-control custom_message_title" placeholder="{{ labels('admin_labels.title_placeholder', 'Title') }}" value="" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <textarea name="message" id="text-box" class="form-control" placeholder="{{ labels('admin_labels.place_some_text_here', 'Place some text here') }}"></textarea>
                                </div>
                            </div>
                            <div class="form-group row place_order d-none">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_custom_message_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_custom_message_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_custom_message_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_custom_message_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalLabel">{{ labels('admin_labels.edit_message', 'Edit Message') }}</h5>
                        <div class="d-flex justify-content-end"><button type="button" class="btn-close"
                                data-bs-dismiss="modal" aria-label="Close"></button></div>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="type">{{ labels('admin_labels.label_type', 'Type') }}</label>
                            <select name="type" class="form-control custom_message_type form-select">
                                <option value=" ">{{ labels('admin_labels.select_type_default', 'Select Type') }}</option>
                                @foreach ($type as $row)
                                    <option value="{{ $row }}">
                                        {{ ucwords(str_replace('_', ' ', $row)) }}
                                    </option>
                        ...
                        <div class="form-group">
                            <label for="title">{{ labels('admin_labels.title_placeholder', 'Title') }}</label>
