                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-sm-12 mb-4">
                                ...
                                <select name="attribute_id" id="attribute" class="w-100"
                                    data-placeholder="{{ labels('admin_labels.type_to_search_and_select_attribute', 'Type to search and select Attribute') }}">
                                    <option value=""></option>
                                </select>

                                <div class="col-sm-12 attribute_name d-none">
                                    <input type="text" class="form-control " id="name" placeholder="{{ labels('admin_labels.name_placeholder', 'Name') }}"
                                        name="name" value="">
                                </div>
                            </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_attribute_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_attribute_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_attribute_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_attribute_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
