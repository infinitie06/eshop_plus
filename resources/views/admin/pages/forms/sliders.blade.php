                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" id="slider_type" class="form-control form-select type_event_trigger mb-2"
                                ...
                                <option value="combo_products">{{ labels('admin_labels.combo_product', 'Combo Product') }}</option>
                                <option value="slider_url">{{ labels('admin_labels.slider_url', 'Slider URL') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-12 mt-2 mb-4">
                            <label for="web_image" class="mb-2">{{ labels('admin_labels.web_image', 'Web Slider Image (Optional)') }}
                            </label>
                            ...
                            <div class="col-md-12">
                                <div class="row form-group">
                                        ...
                                        <div class="mt-2">
                                            <div class="col-md-12  text-center">
                                                <div>
                                                    ...
                                                    <p class="image_recommendation">Recommended Size: 1648 x 610 pixels (Larger for Web)</p>
                                                </div>
                                    ...
                                    <div class="col-md-6 container-fluid row mt-3 image-upload-section">
                                        <div
                                            class="col-md-12 col-sm-12 p-3 mb-5 bg-white rounded m-4 text-center grow web_image d-none">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('admin_slider_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button></li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('admin_slider_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button>
                                            </li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('admin_slider_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button></li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('admin_slider_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
