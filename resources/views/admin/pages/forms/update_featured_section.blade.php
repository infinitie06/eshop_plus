                            ...
                            <div class="tab-content mt-3" id="UpdatebrandTabsContent">
                                ...
                                <div class="tab-pane fade show active" id="content-en" role="tabpanel"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ labels('admin_labels.gucci_placeholder', 'Gucci') }}" name="title"
                                        ...
                                        <input type="text" class="form-control" name="short_description"
                                            ...
                                            placeholder="{{ labels('admin_labels.short_description_placeholder', 'Short description') }}">
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <select name="product_type" class="form-control form-select product_type">
                                    <option value=" ">{{ labels('admin_labels.select_types', 'Select Types') }}</option>
                                    ...
                                    @if (isset($data->id))
                                        @foreach ($product_details as $row)
                                            <option value="{{ $row['id'] }}" selected>
                                                {{ app(TranslationService::class)->getDynamicTranslation(Product::class, 'name', $row['id'], $language_code) }}
                                            </option>
                                        @endforeach
                                    @endif
