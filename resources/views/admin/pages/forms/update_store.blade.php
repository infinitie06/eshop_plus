...
@endsection
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.update_store', 'Update Store')" :subtitle="labels(
                                                ...
                                                <div class="mb-3">
                                                    <label for="brand_name" class="form-label">
                                                        ...
                                                        <i class="fas fa-info-circle text-secondary ms-1"
                                                            ...
                                                            data-bs-content="{{ labels('admin_labels.store_name_instruction', 'Enter the store name as it will appear to customers.') }}"></i>
                                                    </label>
                                                    <input type="text" class="form-control" placeholder="{{ labels('admin_labels.gucci_placeholder', 'Gucci') }}"
                                                        name="name"
                                                    ...
                                                    <input type="text" class="form-control" name="description"
                                                        ...
                                                        placeholder="{{ labels('admin_labels.description_placeholder', 'Description') }}">
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12 col-lg-12">
                                            ...
                                            <textarea name="note_for_necessary_documents" class="form-control"
                                                placeholder="{{ labels('admin_labels.place_food_license_in_other_documents', 'Please attach the food license/pharmacy license in the other documents') }}">{{ isset($data->note_for_necessary_documents) ? $data->note_for_necessary_documents : '' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-4">
                                        <div class="col-md-6 col-lg-3">
                                            <div
                                                ...
                                                <label
                                                    for="">{{ labels('admin_labels.primary_theme_color', 'Primary Theme Color') }}
                                                </label>
                                        ...
                                        <div class="col-md-6 col-lg-3">
                                            <div
                                                class="form-group d-flex col-md-12 align-items-center justify-content-between">
                                                <label
                                                    for="">{{ labels('admin_labels.secondary_theme_color', 'Secondary Theme Color') }}
                                                </label>
                                                <div class="col-md-4 d-flex justify-content-end">
                                                    <input type="color"
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-6 col-lg-3">
                                            <div
                                                class="form-group d-flex col-md-12 align-items-center justify-content-between">
                                                <label for=""
                                                    class="me-8">{{ labels('admin_labels.link_hover_color', 'Link Hover Color') }}
                                                </label>
                                                <div class="col-md-4 d-flex justify-content-end">
                                                    <input type="color"
                                        ...
                                        <div class="col-md-6 col-lg-3">
                                            <div
                                                class="form-group d-flex col-md-12 align-items-center justify-content-between">
                                                <label for=""
                                                    class="me-8">{{ labels('admin_labels.link_active_color', 'Link Active Color') }}
                                                </label>
                                                <div class="col-md-4 d-flex justify-content-end">
                                                    <input type="color"
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-6 col-lg-3">
                                            <div
                                                class="form-group d-flex col-md-12 align-items-center justify-content-between">
                                                <label for=""
                                                    class="me-8">{{ labels('admin_labels.background_color', 'Background Color') }}
                                                </label>
                                                <div class="col-md-4 d-flex justify-content-end">
                                                    <input type="color"
                                    ...
                                    <div class="form-group col-md-12 mb-4">
                                        ...
                                        <div class="web_home_page_theme_images store_style_box home_theme_style_box">
                                            ...
                                            <img src="{{ app(MediaService::class)->getImageUrl('system_images/theme_6.png') }}"
                                                class="web_home_page_theme_6 home_theme home_theme_6" alt="{{ labels('admin_labels.theme_6', 'Theme 6') }}" />
                                        </div>
                                    </div>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select class="feature_section_header_style form-select form-control"
                                                        ...
                                                        <option value="header_style_1"
                                                            ...
                                                            {{ labels('admin_labels.style_1', 'Style 1') }}
                                                        </option>
                                                        ...
                                                        <option value="header_style_3"
                                                            ...
                                                            {{ labels('admin_labels.style_3', 'Style 3') }}</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select class="products_display_style_for_web form-control form-select"
                                                        ...
                                                        <option value="products_display_style_for_web_2"
                                                            ...
                                                            {{ labels('admin_labels.style_2', 'Style 2') }}
                                                        </option>
                                                        <option value="products_display_style_for_web_3"
                                                            ...
                                                            {{ labels('admin_labels.style_3', 'Style 3') }}
                                                        </option>
                                                        <option value="products_display_style_for_web_4"
                                                            ...
                                                            {{ labels('admin_labels.style_4', 'Style 4') }}
                                                        </option>
                                                        <option value="products_display_style_for_web_5"
                                                            ...
                                                            {{ labels('admin_labels.style_5', 'Style 5') }}
                                                        </option>
                                            ...
                                            <div class="tab-pane fade show active" id="categorycontent-en"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ isset($store_settings['category_section_title'])
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select class="slider_style form-control form-select"
                                                        ...
                                                        <option value="slider_style_4"
                                                            ...
                                                            {{ labels('admin_labels.style_4', 'Style 4') }}</option>
                                                        <option value="slider_style_5"
                                                            {{ $store_settings['offer_slider_style'] === 'slider_style_5' ? 'selected' : '' }}>
                                                            {{ labels('admin_labels.style_5', 'Style 5') }}</option>
                                                    </select>
                                                </div>
                            ...
                            <div class="col col-xxl-12">
                                <div class="card p-5">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-3">
                                        ...
                                        <a href="{{ route('admin.zones.index') }}" target="_blank"
                                            ...
                                            <div class="mb-3 col-md-4">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        ...
                                                        @php
                                                            $shipping_settings = app(
                                                                SettingService::class,
                                                            )->getSettings('shipping_method', true);
                                                            $shipping_settings = json_decode($shipping_settings, true);
                                                        @endphp
