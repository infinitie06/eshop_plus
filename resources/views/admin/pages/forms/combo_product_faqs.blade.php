                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('combo_products_faqs_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button>
                                            </li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('combo_products_faqs_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button>
                                            </li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('combo_products_faqs_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button>
                                            </li>
                                            <li><button class="dropdown-item" type="button"
                                                    onclick="exportTableData('combo_products_faqs_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="add_combo_product_faq" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal submit_form" action="{{ route('combo_product_faqs.store') }}"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-12 search_seller_combo_product_parent" id="search_product">
                                <select name="product_id" class="form-select search_seller_combo_product"
                                    data-placeholder="{{ labels('admin_labels.type_to_search_and_select_products', 'Type to search and select products') }}">
                                </select>
                            </div>
                        </div>
                        <div class="mb-3 row">
...
{{-- @section('scripts')
    <script>
        var search_seller_combo_product_url = "{{ route('seller.combo_products.search') }}";
    </script>
    <script src="{{ asset('admin_assets/js/combo_product_faqs.js') }}"></script>
@endsection --}}