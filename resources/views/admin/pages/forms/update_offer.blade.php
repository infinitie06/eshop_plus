                            ...
                            <div class="form-group">
                                ...
                                <select name="type" id="offer_type" class="form-control type_event_trigger form-select"
                                    ...
                                    <option value="categories" {{ $data->type == 'categories' ? 'selected' : '' }}>
                                        {{ labels('admin_labels.category_option', 'Category') }}
                                    </option>
                                    <option value="products" {{ $data->type == 'products' ? 'selected' : '' }}>{{ labels('admin_labels.specific_product_option', 'Specific Product') }}
                                    </option>
                                    <option value="combo_products" {{ $data->type == 'combo_products' ? 'selected' : '' }}>
                                        {{ labels('admin_labels.specific_combo_product', 'Specific Combo Product') }}
                                    </option>
                                    <option value="all_products" {{ $data->type == 'all_products' ? 'selected' : '' }}>
                                        {{ labels('admin_labels.all_products_option', 'All Products') }}
                                    </option>
                                    <option value="all_combo_products"
                                        {{ $data->type == 'all_combo_products' ? 'selected' : '' }}>
                                        {{ labels('admin_labels.all_combo_products', 'All Combo Products') }}
                                    </option>
                                    <option value="brand" {{ $data->type == 'brand' ? 'selected' : '' }}>{{ labels('admin_labels.brand_option', 'Brand') }}
                                    </option>
                                    <option value="offer_url" {{ $data->type == 'offer_url' ? 'selected' : '' }}>{{ labels('admin_labels.offer_url', 'Offer URL') }}
                                    </option>
                                </select>
                            </div>
                            <div id="type_add_html">
                                ...
                                <div
                                    ...
                                    <select name="brand_id" class="form-control">
                                        <option value="">{{ labels('admin_labels.select_brand_placeholder', 'Select brand') }}</option>
