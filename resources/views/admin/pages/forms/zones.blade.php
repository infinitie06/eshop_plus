                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 mt-2">
                                            <input type="text" name="zipcode_delivery_charge" class="form-control"
                                                placeholder="{{ labels('admin_labels.delivery_charge', 'Delivery Charge') }}" value="" />
                                        </div>
                                        <div class="col-md-2">
                                            <input data-repeater-delete type="button" class="btn btn-secondary mt-2"
                                                value="{{ labels('admin_labels.delete', 'Delete') }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <input data-repeater-create type="button" class="btn btn-primary mt-2" value="{{ labels('admin_labels.add', 'Add') }}" />
                        </div>
                        <label for="name"
