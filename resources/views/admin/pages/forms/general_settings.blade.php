            ...
            <form id="general_setting_form" action="{{ route('web_settings.store') }}" class="submit_form"
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="site_title"
                                        ...
                                        placeholder="{{ labels('admin_labels.placeholder_prefix_title_website', 'Prefix title for the website.') }} " />
                                </div>
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                    ...
                                    <input type="text" class="form-control" name="support_number"
                                        ...
                                        placeholder="{{ labels('admin_labels.placeholder_customer_support_mobile', 'Customer support mobile number') }}" />
                                </div>
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                    ...
                                    <input type="text" class="form-control" name="support_email"
                                        ...
                                        placeholder="{{ labels('admin_labels.placeholder_customer_support_email', 'Customer support email') }}" />
                                </div>
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           ...
                                           data-bs-content="{{ labels('admin_labels.tooltip_copyright_footer', 'Copyright information displayed in the website footer.') }}"></i>
                                    </label>
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                                           data-bs-content="{{ labels('admin_labels.tooltip_paste_google_maps_iframe', 'Paste your Google Maps iframe code to show your location.') }}"></i>
                                    </label>
                                ...
                                <div class="col-md-12 form-group">
                                    <label for="image">{{ labels('admin_labels.logo', 'Logo') }}
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                                           data-bs-content="{{ labels('admin_labels.tooltip_upload_logo_size', 'Upload your website logo. Recommended size: 120x120 to 150x150 pixels.') }}"></i>
                                    </label>
                                    <div>
                                        <div class="row">
                                            <div class="col-md-6">
                                ...
                                <div class="col-md-12 form-group">
                                    <label for="image">{{ labels('admin_labels.favicon', 'Favicon') }}
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                                           data-bs-content="{{ labels('admin_labels.tooltip_upload_favicon_size', 'Upload your website favicon. Recommended size: 120x120 to 150x150 pixels.') }}"></i>
                                    </label>
                                    <div>
                                        <div class="row">
                                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                                           data-bs-content="{{ labels('admin_labels.tooltip_meta_keywords_seo', 'Comma separated keywords for SEO.') }}"></i>
                                    </label>
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                                           data-bs-content="{{ labels('admin_labels.tooltip_meta_description_seo', 'Meta description for SEO, shown in search results.') }}"></i>
                                    </label>
                    ...
                    <div class="col-md-12 col-lg-6 mt-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        for="twitter_link">{{ labels('admin_labels.twitter', 'Twitter') }}
                                    </label>
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        for="facebook_link">{{ labels('admin_labels.facebook', 'Facebook') }}
                                    </label>
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        for="instagram_link">{{ labels('admin_labels.instagram', 'Instagram') }}
                                    </label>
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        for="youtube_link">{{ labels('admin_labels.youtube', 'Youtube') }}
                                    </label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="app_download_section_title"
                                        ...
                                        placeholder="{{ labels('admin_labels.placeholder_app_download_section_title', 'App download section title.') }} " />
                                </div>
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                    ...
                                    <input type="text" class="form-control" name="app_download_section_tagline"
                                        ...
                                        placeholder="{{ labels('admin_labels.placeholder_app_download_section_tagline', 'App download section Tagline.') }}" />
                                </div>
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="app_download_section_playstore_url"
                                        ...
                                        placeholder="{{ labels('admin_labels.placeholder_playstore_url', 'Playstore URL.') }} " />
                                </div>
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                    ...
                                    <input type="text" class="form-control" name="app_download_section_appstore_url"
                                        ...
                                        placeholder="{{ labels('admin_labels.placeholder_appstore_url', 'Appstore URL.') }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        for="support_title">{{ labels('admin_labels.title', 'Title') }}
                                    </label>
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        for="shipping_description">{{ labels('admin_labels.description', 'Description') }}
                                    </label>
                    ...
                    <div class="col-md-12 col-lg-6 mt-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        for="shipping_title">{{ labels('admin_labels.title', 'Title') }}
                                    </label>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        for="safety_security_title">{{ labels('admin_labels.title', 'Title') }}
                                    </label>
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        for="safety_security_description">{{ labels('admin_labels.description', 'Description') }}
                                    </label>
                    ...
                    <div class="col-md-12 col-lg-6 mt-md-2 mt-lg-0">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        for="return_title">{{ labels('admin_labels.title', 'Title') }}
                                    </label>
                                ...
                                <div class="col-md-12">
                                    <label class="mb-3 mt-3"
                                        for="return_description">{{ labels('admin_labels.description', 'Description') }}
                                    </label>
                ...
                {{-- <div class="mb-3">
                    <label class="form-label">
                        ...
                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                            data-bs-placement="right"
                            data-bs-content="Enter the purchase code you received after buying eShop Plus for the app."></i>
                    </label>
                ...
                <div class="mb-3">
                    <label class="form-label">
                        ...
                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                            data-bs-placement="right"
                            data-bs-content="Enter the purchase code you received after buying eShop Plus for the web."></i>
                    </label>
                    <input type="text" class="form-control" id="purchase_code"
