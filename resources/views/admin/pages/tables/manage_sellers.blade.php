                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 d-flex justify-content-end mt-md-2 mt-sm-2">
                            <a href="#" class="btn btn-dark me-3 update-seller-commission"
                                title="{{ labels('admin_labels.seller_commission_cron_tooltip', 'If you found seller commission not crediting using cron job you can update seller commission from here!') }}">{{ labels('admin_labels.update_seller_commission', 'Update Seller Commission') }}</a>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_manage_sellers','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button></li>
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_manage_sellers','json')">{{ labels('admin_labels.json', 'JSON') }}</button></li>
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_manage_sellers','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button></li>
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_manage_sellers','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
