                        ...
                        <div class="tab-content mt-3" id="brandTabsContent">
                            <div class="tab-pane fade show active" id="content-en" role="tabpanel" aria-labelledby="tab-en">
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="{{ labels('admin_labels.best_deals', 'Best Deals') }}" name="title" class="form-control"
                                        value="{{ old('title') }}">
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="short_description"
                                        id="short_description" value="" placeholder="{{ labels('admin_labels.short_description_placeholder', 'Short description') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="feature_section_header_style_images feature_section_header_style_box">
                                    <img src="{{ app(MediaService::class)->getImageUrl('system_images/feature_section_heading_style_1.png') }}"
                                        class="header_style_1" alt="{{ labels('admin_labels.feature_section_heading_style_1', 'Feature Section Heading Style 1') }}">
                                    <img src="{{ app(MediaService::class)->getImageUrl('system_images/feature_section_heading_style_2.png') }}"
                                        class="header_style_2" alt="{{ labels('admin_labels.feature_section_heading_style_2', 'Feature Section Heading Style 2') }}">
                                    <img src="{{ app(MediaService::class)->getImageUrl('system_images/feature_section_heading_style_3.png') }}"
                                        class="header_style_3" alt="{{ labels('admin_labels.feature_section_heading_style_3', 'Feature Section Heading Style 3') }}">
                            ...
                            <div class="col-md-6 feature_section_style_main">
                                ...
                                <div class="feature_section_style_images feature_section_style_box">
                                    <img src="{{ app(MediaService::class)->getImageUrl('system_images/featured_section_style_1.png') }}"
                                        class="style_1" alt="{{ labels('admin_labels.featured_section_style_1', 'Featured Section Style 1') }}">
                                    <img src="{{ app(MediaService::class)->getImageUrl('system_images/featured_section_style_2.png') }}"
                                        class="style_2" alt="{{ labels('admin_labels.featured_section_style_2', 'Featured Section Style 2') }}">
                                    <img src="{{ app(MediaService::class)->getImageUrl('system_images/featured_section_style_3.png') }}"
                                        class="style_3" alt="{{ labels('admin_labels.featured_section_style_3', 'Featured Section Style 3') }}">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_featured_section_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button>
                                        </li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_featured_section_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button>
                                        </li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_featured_section_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button>
                                        </li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_featured_section_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
