                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_ticket_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button></li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_ticket_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button></li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_ticket_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button></li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_ticket_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-header d-flex justify-content-between move ui-sortable-handle">
                                ...
                                <div>
                                    ...
                                    <select class="form-control form-select w-100 change_ticket_status" name="status">
                                        ...
                                        <option value={{ 2 }}>{{ labels('admin_labels.open_status', 'OPEN') }}</option>
                                        <option value={{ 3 }}>{{ labels('admin_labels.resolve_status', 'RESOLVE') }}</option>
                                        <option value={{ 4 }}>{{ labels('admin_labels.close_status', 'CLOSE') }}</option>
                                        <option value={{ 5 }}>{{ labels('admin_labels.reopen_status', 'REOPEN') }}</option>
                                    </select>
                                </div>
                            </div>
                            <hr>
                                ...
                                <div class="row">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="message" id="message_input"
                                            placeholder="{{ labels('admin_labels.type_message_placeholder', 'Type Message ...') }}">
                                    </div>
                                </div>
