                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="type" class='form-control form-select'>
                                <option value="credit">{{ labels('admin_labels.credit', 'Credit') }} </option>
                                <option value="debit">{{ labels('admin_labels.debit', 'Debit') }}</option>
                            </select>
                        </div>
                        <div class="col-md-12">
                            <label for="amount"
                                class=" col-form-label">{{ labels('admin_labels.amount', 'Amount') }}</label>
                            <input type="number" min=1 class="form-control" id="amount" placeholder="{{ labels('admin_labels.enter_amount', 'Enter Amount') }}"
                                name="amount">
                        </div>
                        <div class="col-md-12">
                            <label for="message"
                                class=" col-form-label">{{ labels('admin_labels.message', 'Message') }}</label>
                            <textarea class="form-control" id="message" placeholder="{{ labels('admin_labels.enter_message_here', 'Enter Message Here') }}" name="message"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="message" id="transaction_message"
                                placeholder="{{ labels('admin_labels.placeholder_message', 'Message') }}" />
                        </div>
                        <div class="d-flex justify-content-end mt-4">
                            <button type="reset"
                                class="btn mx-2 reset_button">{{ labels('admin_labels.reset', 'Reset') }}</button>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_customer_wallet_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button>
                                    </li>
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_customer_wallet_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button>
                                    </li>
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_customer_wallet_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button>
                                    </li>
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_customer_wallet_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
