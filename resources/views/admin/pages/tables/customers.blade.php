                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_customer_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button></li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_customer_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button></li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_customer_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button></li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('admin_customer_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                    <li><a class="dropdown-item" href="#"
                                                            onclick="exportTableData('customer-address-table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="#"
                                                            onclick="exportTableData('customer-address-table','json')">{{ labels('admin_labels.json', 'JSON') }}</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="#"
                                                            onclick="exportTableData('customer-address-table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="#"
                                                            onclick="exportTableData('customer-address-table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
