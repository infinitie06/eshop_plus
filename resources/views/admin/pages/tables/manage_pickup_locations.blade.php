                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_pickup_location_table','csv')">{{ labels('admin_labels.csv', 'CSV') }}</button></li>
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_pickup_location_table','json')">{{ labels('admin_labels.json', 'JSON') }}</button>
                                    </li>
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_pickup_location_table','sql')">{{ labels('admin_labels.sql', 'SQL') }}</button></li>
                                    <li><button class="dropdown-item" type="button"
                                            onclick="exportTableData('admin_pickup_location_table','excel')">{{ labels('admin_labels.excel', 'Excel') }}</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control pickup_location" name="pickup_location"
                                            placeholder="{{ labels('admin_labels.pickup_location_nickname_hint', 'The nickname of the new pickup location. Max 36 characters.') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control name" name="name"
                                            placeholder="{{ labels('admin_labels.shipper_name_hint', "The shipper's name.") }}" id="name" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control email" name="email"
                                            placeholder="{{ labels('admin_labels.shipper_email_hint', "The shipper's email address.") }}" id="email" value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control phone" name="phone" maxlength="16"
                                            oninput="validateNumberInput(this)" placeholder="{{ labels('admin_labels.shipper_phone_hint', "Shipper's phone number.") }}"
                                            id="phone" value="">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control city" name="city"
                                            placeholder="{{ labels('admin_labels.pickup_location_city_hint', 'Pickup location city name.') }}" id="city" value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control state" name="state"
                                            placeholder="{{ labels('admin_labels.pickup_location_state_hint', 'Pickup location state name.') }}" id="state" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control country" name="country"
                                            placeholder="{{ labels('admin_labels.pickup_location_country_hint', 'Pickup location country.') }}" id="country" value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control pincode" name="pincode"
                                            placeholder="{{ labels('admin_labels.pickup_location_pincode_hint', 'Pickup location pincode.') }}" id="pincode" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label for="address" class="form-label mb-2 mt-2">
                                            {{ labels('admin_labels.address', 'Address') }} <span
                                                class='text-asterisks text-sm'>*</span></label>
                                        <textarea class="form-control address" name="address" placeholder="{{ labels('admin_labels.shipper_address_hint', "Shipper's primary address. Max 80 characters.") }}"
                                            id="address"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control address2" name="address2" placeholder="{{ labels('admin_labels.additional_address_details', 'Additional address details.') }}" id="address2"><?= isset($fetched_data[0]['address_2']) ? $fetched_data[0]['address_2'] : '' ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control latitude" name="latitude"
                                            placeholder="{{ labels('admin_labels.pickup_location_latitude_hint', 'Pickup location Latitude.') }}" id="latitude" value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control longitude" name="longitude"
                                            placeholder="{{ labels('admin_labels.pickup_location_longitude_hint', 'Pickup location Longitude.') }}" id="longitude" value="">
                                    </div>
                                </div>
                            </div>
