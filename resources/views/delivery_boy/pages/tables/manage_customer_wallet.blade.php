                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-12">
                                    <textarea type="text" class="form-control" placeholder="{{ labels('admin_labels.payment_details', 'Payment Details') }}" name="payment_address"></textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="amount"
                                    class="col-sm-12 form-label">{{ labels('admin_labels.amount', 'Amount') }}<span
                                        class='text-asterisks text-sm'>*</span></label>
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" placeholder="{{ labels('admin_labels.amount', 'Amount') }}" name="amount" min=1>
                                </div>
                            </div>
                        </div>
                    </div>
