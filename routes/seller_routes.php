...
Route::group(
    ...
    function () {
        ...
        Route::get('seller/stores', [UserController::class, 'stores'])->name('seller.stores.index');
        Route::get('seller/stores/create', [UserController::class, 'createStore'])->name('seller.stores.create');
        Route::post('seller/stores/store', [UserController::class, 'storeStore'])->name('seller.stores.store')->middleware(['demo_restriction']);

        Route::post('seller/store/deactivate', [UserController::class, 'deactivateStore'])->name('seller.store.deactivate')->middleware(['demo_restriction']);
        Route::post('seller/store/delete', [UserController::class, 'deleteStore'])->name('seller.store.delete')->middleware(['demo_restriction']);
        Route::post('seller/store/activate', [UserController::class, 'activateStore'])->name('seller.store.activate')->middleware(['demo_restriction']);
        ...
        Route::get('seller/categories/requested-list', [CategoryController::class, 'listRequested'])->name('seller_categories.requested.list');
        ...
        // Product Pickup Locations Management
        Route::get('seller/manage_product_pickup_locations', [ProductController::class, 'productPickupLocations'])->name('seller.product.pickup_locations');
        Route::get('seller/manage_product_pickup_locations/list', [ProductController::class, 'productPickupLocationsList'])->name('seller.product.pickup_locations.list');
        Route::post('/seller/update_product_pickup_locations', [ProductController::class, 'bulkUpdatePickupLocations'])->name('seller.pickup_locations.bulk.update')->middleware(['demo_restriction']);

        // Combo Product Pickup Locations Management
        Route::get('seller/manage_combo_product_pickup_locations', [ComboProductController::class, 'comboProductPickupLocations'])->name('seller.combo_product.pickup_locations');
        Route::get('seller/manage_combo_product_pickup_locations/list', [ComboProductController::class, 'comboProductPickupLocationsList'])->name('seller.combo_product.pickup_locations.list');
        Route::post('/seller/update_combo_product_pickup_locations', [ComboProductController::class, 'bulkUpdatePickupLocations'])->name('seller.combo.pickup_locations.bulk.update')->middleware(['demo_restriction']);
