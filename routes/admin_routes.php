...
Route::get('admin/affiliate_user/settle_commission', [AffiliateController::class, 'settleCommission'])->name('admin.affiliate_user.settle_commission')->middleware(['demo_restriction']);
...
Route::group(
    ...
    function () {
        ...
        Route::prefix('admin')->group(function () {
            ...
            Route::get("settings/admin_preference", [SettingController::class, 'adminPreference'])->name('admin.admin_preference');

            Route::post("settings/admin_preference", [SettingController::class, 'storeAdminPreference'])->name('admin_preference.store')->middleware(['demo_restriction']);
        ...
        Route::post('admin/products/delete_image', [ProductController::class, 'deleteImage']);
        //seller
      ...
      Route::post('admin/set_store', function (Request $request) {
        ...
        Route::get('/download-language-json-file/{language_code}/{type}', [LanguageController::class, 'downloadLanguageJsonFile'])->name('download.language.json.file');

        Route::post('/admin/compare-language-labels', [LanguageController::class, 'compareLanguageLabels'])->name('compare.language.labels');

        Route::get('admin/get-language-file-info', [LanguageController::class, 'getLanguageFileInfo'])->name('get.language.file.info');
        ...
        Route::get("admin/manage_affiliate_users", [AffiliateController::class, 'manage_users'])->name('admin.affiliate.manage_user');
        Route::get("admin/add_affiliate_user", [AffiliateController::class, 'index'])->name('admin.affiliate.add_user');
        Route::post('/admin/affiliate_users/store', [AffiliateController::class, 'store'])->name('admin.affiliate_users.store');
        Route::get('admin/affiliate_users/list', [AffiliateController::class, 'list'])->name('admin.affiliate_users.list');
        Route::get('/admin/affiliate_users/{id}/edit', [AffiliateController::class, 'edit'])->name('admin.affiliate_users.edit');
        Route::put('/admin/affiliate_users/{id}', [AffiliateController::class, 'update'])->name('admin.affiliate_users.update');

        // affiliate setting routes

        Route::get("admin/affiliate_settings", [AffiliateSettingController::class, 'index'])->name('admin.affiliate.settings');
        Route::post('admin/affiliate_settings/store', [AffiliateSettingController::class, 'store'])->name('admin.affiliate.settings.store');
        Route::post('admin/affiliate_settings/update_commission', [AffiliateSettingController::class, 'updateCommission'])->name('admin.affiliate.settings.update_commission');
        Route::get("admin/affiliate_policies", [AffiliateSettingController::class, 'policies'])->name('admin.affiliate.policies');

        Route::post("settings/affiliate_privacy_policy", [AffiliateSettingController::class, 'storeAffiliatePrivacyPolicy'])->name('affiliate_privacy_policy.store')->middleware(['demo_restriction'])->middleware('permissions:edit affiliate_policies');

        Route::post("settings/affiliate_terms_and_conditions", [AffiliateSettingController::class, 'storeAffiliateTermsAndConditions'])->name('affiliate_terms_and_conditions.store')->middleware(['demo_restriction'])->middleware('permissions:edit affiliate_policies');

        //   affiliate reports routes

        Route::get("admin/affiliate/reports", [AffiliateController::class, 'reports'])->name('admin.affiliate.reports');

        // SEO Management Routes
        
        Route::prefix('admin/seo')->group(function () {
            Route::get('/', [SeoController::class, 'index'])->name('admin.seo.index')->middleware('permissions:view seo');
            
            // Global SEO
            Route::get('/global', [SeoController::class, 'globalSettings'])->name('admin.seo.global')->middleware('permissions:view seo');
            Route::post('/global', [SeoController::class, 'storeGlobalSettings'])->name('admin.seo.global.store')->middleware(['demo_restriction'])->middleware('permissions:edit seo');
            
            // Product SEO
            Route::get('/products', [SeoController::class, 'productSeoIndex'])->name('admin.seo.products')->middleware('permissions:view seo');
            Route::get('/products/list', [SeoController::class, 'productSeoList'])->name('admin.seo.products.list');
            Route::get('/products/{id}/edit', [SeoController::class, 'editProductSeo'])->name('admin.seo.products.edit')->middleware('permissions:view seo');
            Route::put('/products/{id}', [SeoController::class, 'updateProductSeo'])->name('admin.seo.products.update')->middleware(['demo_restriction'])->middleware('permissions:edit seo');
            
            // Category SEO
            Route::get('/categories', [SeoController::class, 'categorySeoIndex'])->name('admin.seo.categories')->middleware('permissions:view seo');
            Route::get('/categories/list', [SeoController::class, 'categorySeoList'])->name('admin.seo.categories.list');
            Route::get('/categories/{id}/edit', [SeoController::class, 'editCategorySeo'])->name('admin.seo.categories.edit')->middleware('permissions:view seo');
            Route::put('/categories/{id}', [SeoController::class, 'updateCategorySeo'])->name('admin.seo.categories.update')->middleware(['demo_restriction'])->middleware('permissions:edit seo');
            
            // Blog SEO
            Route::get('/blogs', [SeoController::class, 'blogSeoIndex'])->name('admin.seo.blogs')->middleware('permissions:view seo');
            Route::get('/blogs/list', [SeoController::class, 'blogSeoList'])->name('admin.seo.blogs.list');
            Route::get('/blogs/{id}/edit', [SeoController::class, 'editBlogSeo'])->name('admin.seo.blogs.edit')->middleware('permissions:view seo');
            Route::put('/blogs/{id}', [SeoController::class, 'updateBlogSeo'])->name('admin.seo.blogs.update')->middleware(['demo_restriction'])->middleware('permissions:edit seo');
            
            // Sitemap & Robots
            Route::get('/sitemap', [SeoController::class, 'sitemapAndRobots'])->name('admin.seo.sitemap')->middleware('permissions:view seo');
            Route::post('/robots', [SeoController::class, 'updateRobotsTxt'])->name('admin.seo.robots.update')->middleware(['demo_restriction'])->middleware('permissions:edit seo');
        });
    }
