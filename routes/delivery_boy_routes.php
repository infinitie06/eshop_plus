...
Route::group(
    ['middleware' => ['auth', 'role:delivery_boy']],
    function () {
        ...
        Route::put('delivery_boy/availability/toggle', [UserController::class, 'toggleAvailability'])->name('delivery_boy.availability.toggle')->middleware(['demo_restriction']);
