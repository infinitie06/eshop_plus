...
Route::group(['middleware' => ['check_token', 'auth:sanctum']], function () {
    ...
    Route::delete('delete_requested_category', [ApiController::class, 'delete_requested_category']);
    Route::delete('delete_requested_brand', [ApiController::class, 'delete_requested_brand']);
    ...
    Route::delete('delete_pickup_location', [ApiController::class, 'delete_pickup_location']);
    Route::post('bulk_update_product_pickup_locations', [ApiController::class, 'bulk_update_product_pickup_locations']);
    Route::post('bulk_update_combo_product_pickup_locations', [ApiController::class, 'bulk_update_combo_product_pickup_locations']);
    ...
    Route::put('activate_store', [ApiController::class, 'activate_store']);
    Route::put('deactivate_store', [ApiController::class, 'deactivate_store']);
    Route::delete('delete_store', [ApiController::class, 'delete_store']);
