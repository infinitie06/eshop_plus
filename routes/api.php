...
Route::get('get_language_file_info', [ApiController::class , 'get_language_file_info'])->middleware('language');
Route::get('get_blogs', [ApiController::class , 'get_blogs'])->middleware('language');
Route::get('get_blog_details', [ApiController::class , 'get_blog_details'])->middleware('language');
Route::get('get_blog_categories', [ApiController::class , 'get_blog_categories'])->middleware('language');
...
Route::match (['get', 'post'], 'app_payment_status', [ApiController::class , 'app_payment_status'])->name('app_payment_status');
...
// Affiliate deep link tracking
Route::get('affiliate/redirect', [ApiController::class , 'affiliate_redirect']);
Route::post('affiliate/track_click', [ApiController::class , 'track_affiliate_click']);

// Deep link generation and redirect for products, sellers, and blogs
Route::get('deep_link/generate', [ApiController::class , 'generate_deep_link']);
Route::get('deep_link/redirect', [ApiController::class , 'deep_link_redirect']);

Route::post('verify_credentials', [ApiController::class , 'verify_credentials']);
// -------------------------------------------------------------------------------------
...
Route::group(['middleware' => ['check_token', 'auth:sanctum']], function () {
    ...
    Route::post('track_affiliate_conversion', [ApiController::class , 'track_affiliate_conversion']);
// Route::get('get_paypal_link', [ApiController::class, 'get_paypal_link']);
// Route::get('/paypal_transaction_webview', [ApiController::class, 'paypal_transaction_webview'])->name('paypal_transaction_webview');
});