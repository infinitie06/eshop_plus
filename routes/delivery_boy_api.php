...
Route::group(['middleware' => ['check_token', 'auth:sanctum']], function () {
    ...
    Route::get('get_delivery_boy_cash_collection', [ApiController::class, 'get_delivery_boy_cash_collection'])->middleware('language');
    Route::delete('delete_delivery_boy', [ApiController::class, 'delete_delivery_boy']);
    Route::get('get_wallet_transaction', [ApiController::class, 'get_wallet_transaction'])->middleware('language');
    ...
    Route::get('get_availability_status', [ApiController::class, 'get_availability_status']);
