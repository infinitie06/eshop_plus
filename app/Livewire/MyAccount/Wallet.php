...
class Wallet extends Component
{
    ...
    {
        // Auto-refresh wallet if coming from successful payment
        if (request()->has('response') && request()->get('response') === 'wallet_success') {
            // Force refresh the component after a short delay to ensure balance is updated
