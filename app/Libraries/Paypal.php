...
class Paypal
{
    ...
    function __construct()
    {
        try {
            ...
            $this->paypal_business_email = $settings->paypal_business_email ?? "sb-owt4r32777831@business.example.com";
            $this->paypal_client_id = $settings->paypal_client_id ?? "";
            $this->currency_code = $settings->currency_code ?? "USD";
        } catch (\Exception $e) {
            // Fallback to sandbox test values when database is not available
            $this->paypal_mode = "sandbox";
            $this->paypal_business_email = "sb-owt4r32777831@business.example.com";
        ...
        $businessEmail = $this->paypal_business_email;
