    ...
    public function combo_stock_list()
    {
        ...
        foreach ($products['combo_product'] as $product) {
            ...
            <div class="dropdown-menu table_dropdown stock_action_dropdown" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item edit-combo-stock" title="Edit" data-id="' . $product->id . '" data-bs-toggle="modal" data-bs-target="#edit_modal"><i class="bx bx-pencil"></i> ' . labels('admin_labels.edit', 'Edit') . '</a>
            </div>
        </div>';
