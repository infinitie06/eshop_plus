...
class ComboProductFaqController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $product_faqs = $product_faqs
            ...
            <a class="dropdown-item dropdown_menu_items edit-combo-product-faq" data-id="' . $p->id . '" data-bs-toggle="modal" data-bs-target="#edit_modal"><i class="bx bx-pencil mx-2"></i> ' . labels('admin_labels.edit', 'Edit') . '</a>
