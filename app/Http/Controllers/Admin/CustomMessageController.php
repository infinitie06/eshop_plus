...
class CustomMessageController extends Controller
{
    ...
    public function store(Request $request)
    {
        $rules = [
            'type' => [
                ...
                function ($attribute, $value, $fail) {
                    if (CustomMessage::where('type', $value)->exists()) {
        ...
        // Use your global HandlesValidation trait for cleaner JSON error responses
        ...
        return response()->json([
            ...
            'location' => route('admin.custom_message.index') // adjust route name if needed
        ]);
    }
