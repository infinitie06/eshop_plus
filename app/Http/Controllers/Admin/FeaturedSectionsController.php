    ...
    public function list()
    {
        ...
        $section = $section->orderBy($sort, $order)
            ...
            ->map(function ($s) use ($product_type_labels, $styles, $language_code) {
                ...
                $banner_image_url = app(MediaService::class)->getMediaImageUrl($s->banner_image);
                return [
                    'id' => $s->id,
                    ...
                    'banner_image' => '<div class="d-flex justify-content-around"><a href="' . $banner_image_url . '" data-lightbox="banner-' . $s->id . '"><img src="' . $banner_image_url . '" alt="Banner" class="rounded" width="60" style="max-width:60px;height:auto;"/></a></div>',
