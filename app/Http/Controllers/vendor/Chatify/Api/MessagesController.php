...
class MessagesController extends Controller
{
    ...
    public function send(Request $request)
    {
        ...
        if (!$error->status) {
            ...
            $message = Chatify::newMessage([
                ...
                'from_name' => auth('sanctum')->user()->username,
                'to_id' => $request['id'],
            ...
            if (auth('sanctum')->user()->id != $request['id']) {
                ...
                $fcmMsg = [
                    ...
                    'user_name' => auth('sanctum')->user()->username, // make sure receiver checks 'user_name'
                ];
    ...
    public function search(Request $request)
    {
        ...
        foreach ($records->items() as $index => $record) {
            ...
            $userWithAvatar->fcm_id = $userWithAvatar->fcm_id
                ? [$userWithAvatar->fcm_id]
                : [];
